      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 flex flex-col md:flex-row gap-10">
        ...
        <section className="flex-1 min-w-0">
          <h2 className="text-3xl font-black text-slate-800 tracking-tight mb-8 pb-4 border-b-2 border-slate-200">
            스마트 LED 제어 솔루션 <span className="text-lg text-slate-400 font-normal tracking-widest uppercase ml-2">Specification</span>
          </h2>
          <div className="mb-14">
            ...
            <p className="text-slate-700 leading-relaxed break-keep text-[15px]">
              플로림(FLOLIM) 스마트 LED 제어 솔루션은 조명 기구에 직접 이식되는 초소형 <b>무선 제어 모듈(디밍 컨트롤러)</b>과 주변 환경을 감지하는 <b>복합 센서(동체/조도)</b>로 구성된 하드웨어 시스템입니다. 기존 시스템의 복잡한 릴레이 배선 방식에서 벗어나, 모듈 간 무선 통신을 통해 구축 비용을 낮추고 완벽한 개별/그룹 제어를 실현합니다.
            </p>
          </div>
          <div className="mb-14">
            ...
            <table className="w-full border-t-2 border-slate-800 text-[14px]">
              <tbody>
                <tr className="border-b border-slate-200"><th className="bg-slate-50 py-3 px-4 text-left font-bold text-slate-700 w-1/4">통신 프로토콜</th><td className="py-3 px-4 text-slate-600">Matter 기반 무선 통신 (Wi-Fi, Thread 호환)</td></tr>
                <tr className="border-b border-slate-200"><th className="bg-slate-50 py-3 px-4 text-left font-bold text-slate-700">디밍 출력 방식</th><td className="py-3 px-4 text-slate-600">0~10V DC Dimming, PWM 제어, DALI 지원</td></tr>
                <tr className="border-b border-slate-200"><th className="bg-slate-50 py-3 px-4 text-left font-bold text-slate-700">입력 전압</th><td className="py-3 px-4 text-slate-600">AC 100~240V (50/60Hz)</td></tr>
                <tr className="border-b border-slate-200"><th className="bg-slate-50 py-3 px-4 text-left font-bold text-slate-700">센서 스펙</th><td className="py-3 px-4 text-slate-600">PIR 동체 감지 센서 (감지 반경 최대 8m) / 포토 조도 센서 내장</td></tr>
              </tbody>
            </table>
          </div>
        </section>
