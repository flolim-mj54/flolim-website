          ...
          <div className="border border-slate-300">
            ...
            <ul className="flex flex-col">
              ...
              <li className="border-b border-slate-200 last:border-0">
                <Link to="/smart-led-solution" className="flex items-center justify-between px-4 py-4 text-[13px] lg:text-[14px] tracking-tight bg-cyan-50 text-[#1eb4c8] font-bold whitespace-nowrap">
