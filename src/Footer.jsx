    ...
    <footer className="bg-slate-50 text-slate-600 py-16 border-t-4 border-[#1eb4c8]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 border-b border-slate-200 pb-12">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2 text-[13px] text-slate-500 mb-6 break-keep">
              <li>
                <span className="font-semibold text-slate-700">주소:</span> 충남
                천안시 서북구 2공단4로 40-11 천안G1비즈캠퍼스 1223호 주식회사
                플로림
              </li>
              <li>
                <span className="font-semibold text-slate-700">전화:</span>{" "}
                1660-0687
              </li>
              <li>
                <span className="font-semibold text-slate-700">메일:</span>{" "}
                info@flolim.com
              </li>
            </ul>
          </div>
          ...
          {/* 2. 대메뉴: 가로등 제어 시스템 */}
          <div className="md:col-span-1">
            <h4 className="text-slate-800 font-bold mb-6 text-sm border-l-2 border-[#1eb4c8] pl-2">
              가로등 제어 시스템
            </h4>
            <ul className="space-y-3 text-sm">
              <li>
                <a href="#" className="hover:text-[#1eb4c8] transition-colors">
                  가로등 제어 시스템
                </a>
              </li>
              <li>
          ...
          <div className="md:col-span-1">
            ...
            <h4 className="text-slate-800 font-bold mb-4 text-sm border-l-2 border-[#1eb4c8] pl-2">
              고객지원
            </h4>
            <ul className="space-y-3 text-sm">
              <li>
        ...
        <div className="mt-8 text-sm text-slate-400 text-center flex flex-col md:flex-row justify-between items-center">
          <p>
            Copyright © {new Date().getFullYear()} FloLim Co., Ltd. All rights
            reserved.
          </p>
