    ...
    <div className="pb-20 bg-[#020617] min-h-screen text-slate-200 selection:bg-flolim selection:text-slate-900 overflow-hidden">
      <section className="relative min-h-[90vh] flex items-center justify-center pt-20 pb-10">
        <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
          ...
          <div
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] md:w-[1200px] h-[800px] md:h-[1200px] bg-flolim/20 rounded-full blur-[150px] opacity-40 animate-pulse"
        ...
        <div
          className={`container mx-auto px-4 max-w-6xl relative z-10 text-center transition-all duration-1000 transform ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
        >
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white leading-tight mb-8 tracking-tight drop-shadow-xl">
            세상을 밝히는{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 drop-shadow-[0_0_20px_rgba(24,169,198,0.5)]">
              지능형 연결
            </span>
            <br />
            플로림이 완성합니다
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/business/esco"
              className="w-full sm:w-auto px-8 py-4 bg-flolim hover:bg-cyan-400 active:scale-95 text-slate-900 font-bold rounded-2xl shadow-[0_0_20px_rgba(24,169,198,0.4)] transition-all duration-300 flex items-center justify-center gap-2 hover:-translate-y-1"
            >
              초기 투자비 0원 도입 알아보기
              <svg
                className="w-5 h-5"
            ...
            <Link
              ...
              className="w-full sm:w-auto px-8 py-4 bg-slate-900/80 backdrop-blur-md hover:bg-slate-800 active:scale-95 text-white font-bold rounded-2xl border border-slate-600 hover:border-flolim transition-all duration-300 flex items-center justify-center gap-2 hover:-translate-y-1 shadow-lg"
            >
              우리 회사 절감액 계산기
            </Link>
          </div>
        ...
        <section className="bg-slate-900/70 backdrop-blur-xl rounded-[2.5rem] p-6 md:p-8 lg:p-12 shadow-[0_30px_60px_rgba(0,0,0,0.5)] border border-slate-700 relative overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-slate-700/50">
            <div className="px-2 lg:px-4 py-2 flex flex-col justify-center">
              <p className="text-slate-400 font-medium mb-2 text-sm lg:text-base break-keep">
                KEPCO ES 연계 ESCO 모델
              </p>
              ...
              <div className="text-3xl lg:text-4xl font-black text-white mb-2 tracking-tight whitespace-nowrap">
                도입 비용{" "}
                <span className="text-flolim drop-shadow-[0_0_10px_rgba(24,169,198,0.5)]">
                  0
                </span>
                원
              </div>
              <p className="text-xs text-slate-500 font-light break-keep mt-auto">
                전액 무상 교체 및 절감액 분할 상환
              </p>
            </div>
        ...
        <section className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-8 md:p-16 shadow-2xl border border-slate-800 relative overflow-hidden">
          ...
          <div className="text-center mb-12 md:mb-16 relative z-10">
            ...
            <p className="text-slate-400 font-light text-sm md:text-base break-keep">
              현장의 규모와 목적에 맞는 플로림의 맞춤형 시스템을 확인하세요.
            </p>
          </div>
      ...
      <div className="container mx-auto px-4 max-w-6xl mt-16 mb-10">
        <section className="bg-gradient-to-br from-[#050b14] to-slate-900 rounded-[2.5rem] p-8 md:p-16 shadow-2xl border border-flolim/30 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8 md:gap-10">
          ...
          <div className="relative z-10 text-center md:text-left">
            <h2 className="text-2xl md:text-3xl font-black text-white mb-2 md:mb-3 break-keep">
              도입을 망설이고 계신가요?
            </h2>
            <p className="text-slate-400 font-light text-sm md:text-lg break-keep">
              플로림 전문 컨설턴트가 귀사의 현장에 맞는 최적의 절감 시나리오를
              무상으로 제안해 드립니다.
            </p>
          </div>
