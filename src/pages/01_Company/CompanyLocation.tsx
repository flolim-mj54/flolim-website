      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10 mt-10">
        ...
        <section className="bg-slate-900/50 backdrop-blur-sm rounded-[2.5rem] p-6 md:p-10 lg:p-12 shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
          ...
          <div className="mb-8 md:mb-10 relative z-10">
            ...
            <p className="text-slate-400 font-light text-xs md:text-sm break-keep">충청남도 천안시 서북구 2공단4로 40-11, 천안G1비즈캠퍼스 1223호</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
            ...
            <div className="bg-[#050b14] p-6 md:p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/50 active:scale-[0.98] active:border-flolim transition-all duration-300 group relative overflow-hidden">
              ...
              <h3 className="text-lg md:text-xl font-bold text-white mb-3 md:mb-4 group-hover:text-flolim transition-colors relative z-10 break-keep">본사 주소</h3>
              <p className="text-slate-400 leading-relaxed font-light text-xs md:text-sm relative z-10 break-keep">
                충청남도 천안시 서북구<br/>
                2공단4로 40-11<br/>
                천안G1비즈캠퍼스 1223호
              </p>
            ...
            <div className="bg-[#050b14] p-6 md:p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/50 active:scale-[0.98] active:border-flolim transition-all duration-300 group relative overflow-hidden">
              ...
              <h3 className="text-lg md:text-xl font-bold text-white mb-3 md:mb-4 group-hover:text-flolim transition-colors relative z-10 break-keep">대표 연락처</h3>
              <ul className="space-y-3 text-slate-400 font-light text-xs md:text-sm relative z-10">
            ...
            <div className="bg-[#050b14] p-6 md:p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/50 active:scale-[0.98] active:border-flolim transition-all duration-300 group relative overflow-hidden">
              ...
              <h3 className="text-lg md:text-xl font-bold text-white mb-3 md:mb-4 group-hover:text-flolim transition-colors relative z-10 break-keep">교통 및 주차 안내</h3>
              <p className="text-slate-400 leading-relaxed font-light text-xs md:text-sm mb-4 relative z-10 break-keep">
                차량 방문 시 <strong className="font-bold text-white">G1비즈캠퍼스 지상 또는 지하 주차장</strong>을 이용해 주시기 바랍니다. 
              </p>
              <div className="bg-slate-800/50 p-3 rounded-xl text-[10px] md:text-xs text-slate-300 flex items-center gap-2 border border-slate-700 relative z-10 break-keep">
