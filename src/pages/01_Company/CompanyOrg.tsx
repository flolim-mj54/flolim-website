  ...
  const departments = [
    {
      ...
      title: "솔루션사업부",
      desc: "사업 기획 및\n프로젝트 총괄 운영",
      textColor: "text-flolim",
      lineHorizontal: "left-1/2 right-0",
      cardHover:
        "hover:border-flolim hover:shadow-[0_10px_30px_rgba(24,169,198,0.15)]",
    ...
    },
    {
      ...
      lineHorizontal: "left-0 right-0",
      cardHover:
        "hover:border-amber-400 hover:shadow-[0_10px_30px_rgba(251,191,36,0.15)]",
    ...
    },
    {
      ...
      lineHorizontal: "left-0 right-0",
      cardHover:
        "hover:border-blue-400 hover:shadow-[0_10px_30px_rgba(96,165,250,0.15)]",
    ...
    },
    {
      ...
      lineHorizontal: "left-0 right-0",
      cardHover:
        "hover:border-purple-400 hover:shadow-[0_10px_30px_rgba(192,132,252,0.15)]",
    ...
    },
    {
      ...
      title: "영업부",
      desc: "솔루션 컨설팅 및\n고객사 제휴",
      // 💡 영업부의 라인이 가운데를 관통하도록 변경
      textColor: "text-rose-400",
      lineHorizontal: "left-0 right-0",
      cardHover:
        "hover:border-rose-400 hover:shadow-[0_10px_30px_rgba(251,113,133,0.15)]",
    ...
    // 💡 새롭게 추가된 고객지원부
    {
      ...
      lineHorizontal: "left-0 right-1/2",
      cardHover:
        "hover:border-emerald-400 hover:shadow-[0_10px_30px_rgba(52,211,153,0.15)]",
      iconHover: "group-hover:bg-emerald-400 group-hover:text-slate-900",
  ...
  return (
    <div className="pb-10 relative overflow-hidden">
      ...
      <PageHeader
        ...
        subtitle={
          <>
            세상을 밝히는 지능형 연결을 완성하기 위해,
            <br className="hidden md:block" />
            <strong className="text-white font-bold">
              각 분야의 최고 전문가들이 유기적으로 협력
            </strong>
            하고 있습니다.
          </>
        }
      ...
      <div className="container mx-auto px-4 max-w-6xl mt-10">
        <section className="bg-slate-900/50 pt-12 pb-16 md:pt-16 md:pb-20 rounded-[2.5rem] shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
          ...
          <div className="text-center mb-10 relative z-10 px-4">
            <h2 className="text-xl md:text-2xl font-bold text-white mb-2 break-keep">
              플로림 조직 구성
            </h2>
            <p className="text-slate-400 font-light text-xs md:text-sm break-keep">
              유연하고 수평적인 조직 문화를 바탕으로 신속한 의사결정과 혁신을
              주도합니다.
              <br className="hidden md:block" />
              <span className="md:hidden text-flolim font-medium">
                (※ 표를 좌우로 스크롤하여 확인하세요.)
              </span>
            </p>
          </div>
          ...
          <div className="w-full overflow-x-auto pb-10 px-4 md:px-8 relative z-10 custom-scrollbar">
            {/* 💡 카드가 6개로 늘어났으므로 모바일 환경에서 더 넓은 min-w 확보 (900px -> 1080px) */}
            <div className="min-w-[1080px] lg:min-w-full flex flex-col items-center pt-2 relative">
              <div className="group/ceo inline-flex flex-col items-center justify-center gap-1 bg-[#050b14] border border-slate-700 hover:bg-slate-800/80 hover:border-flolim hover:shadow-[0_10px_30px_rgba(24,169,198,0.2)] hover:-translate-y-2 px-12 py-5 rounded-full shadow-inner relative z-20 cursor-default transition-all duration-300 overflow-hidden">
                ...
                <div className="flex items-center gap-2 mb-1 relative z-10">
                  ...
                  <span className="text-slate-400 group-hover/ceo:text-flolim transition-colors font-bold text-[10px] tracking-widest uppercase">
                    CEO
                  </span>
                </div>
                <div className="text-xl md:text-2xl font-black text-white tracking-[0.2em] ml-1 relative z-10 group-hover/ceo:text-flolim transition-colors">
                  대 표
                </div>
              </div>
              ...
              <div className="flex w-full relative">
                {departments.map((dept) => (
                  // 💡 w-1/5 (20%) 에서 w-1/6 (16.666%) 로 변경
                  <div
                    key={dept.id}
                    className="w-1/6 relative pt-8 px-2 md:px-3 flex flex-col items-center group"
                  >
                    {/* 수평선 */}
                    <div
                      className={`absolute top-0 ${dept.lineHorizontal} h-1 bg-flolim shadow-[0_0_10px_rgba(24,169,198,0.5)]`}
                    ></div>
                    {/* 수직선 */}
                    ...
                    {/* 부서 카드 본체 */}
                    <div
                      className={`w-full bg-[#050b14] p-5 md:p-6 rounded-2xl md:rounded-3xl border border-slate-700 flex flex-col items-center text-center transition-all duration-300 shadow-inner group-hover:bg-slate-800/80 ${dept.cardHover} group-hover:-translate-y-2 cursor-default h-full relative overflow-hidden`}
                    >
                      <div
                        className={`absolute -right-6 -top-6 w-20 h-20 ${dept.bgGlow} rounded-full z-0 group-hover:scale-150 transition-transform duration-700 pointer-events-none`}
                      ></div>

                      <div
                        className={`w-12 h-12 md:w-14 md:h-14 bg-slate-800 rounded-xl md:rounded-2xl flex items-center justify-center mb-3 md:mb-4 border border-slate-600 group-hover:scale-110 ${dept.iconHover} transition-all shadow-sm relative z-10 ${dept.textColor}`}
                      >
                        {dept.icon}
                      </div>

                      <h3
                        className={`font-bold text-white text-sm md:text-base mb-2 ${dept.titleHover} transition-colors break-keep relative z-10`}
                      >
                        {dept.title}
                      </h3>
