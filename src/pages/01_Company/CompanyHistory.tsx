      ...
      <div className="container mx-auto px-4 max-w-5xl relative z-10 mb-10 mt-10">
        ...
        <section className="bg-slate-900/50 backdrop-blur-sm rounded-[2.5rem] p-8 md:p-16 shadow-2xl border border-slate-800 relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto py-10 z-10">
            ...
            {/* 2026년 */}
            <div className="mb-20 md:mb-24 relative w-full flex flex-col md:flex-row items-start md:items-center justify-between group">
              <div className="md:w-5/12 text-left md:text-right pr-0 md:pr-16 pl-14 md:pl-0 mb-6 md:mb-0">
                <h2 className="text-4xl md:text-6xl font-black text-slate-700 tracking-tighter drop-shadow-sm group-hover:text-flolim transition-colors duration-500 origin-right">
                  2026
                </h2>
              </div>
            ...
            <div className="mb-10 relative w-full flex flex-col md:flex-row items-start md:items-center justify-between group">
              <div className="md:w-5/12 text-left pr-0 md:pl-16 pl-14 md:order-3 mb-6 md:mb-0">
                <h2 className="text-4xl md:text-6xl font-black text-slate-700 tracking-tighter group-hover:text-flolim transition-colors duration-500 origin-left">
                  2025
                </h2>
              </div>
