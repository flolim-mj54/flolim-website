    ...
    <div className="pb-10 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-6xl mt-10">
        ...
        <section className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-6 md:p-16 shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16 relative z-10">
            ...
            <div className="bg-[#050b14] p-6 md:p-8 rounded-3xl border border-slate-700 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8 shadow-inner relative overflow-hidden">
              <div className="flex flex-col items-center md:items-start text-center md:text-left w-full md:w-auto relative z-10">
                <span className="text-xs md:text-sm text-flolim font-bold mb-1 tracking-wider">교체 대상 수량</span>
                <span className="text-lg md:text-xl text-white font-black">노후 조명 개수</span>
              </div>
          ...
          {/* 💡 [수정] 모바일 화면 잘림(Overflow) 해결을 위한 레이아웃 재구성 */}
          <div className="relative flex justify-center items-end gap-10 md:gap-16 mb-16 h-56 md:h-64 border-b border-slate-800 pb-10 z-10">
            ...
            <div className="flex flex-col items-center w-24 md:w-32">
              ...
              <span className="mt-4 md:mt-5 font-bold text-slate-300 text-sm md:text-base">교체 전</span>
            </div>

            {/* 절감액 강조 (가운데) - 모바일에서는 아래로 빼서 겹치게(absolute) 처리 */}
            <div className="absolute -bottom-5 left-1/2 -translate-x-1/2 md:static md:translate-x-0 flex flex-col items-center justify-center pb-0 md:pb-12 z-20 w-[90%] md:w-auto">
              <div className="bg-flolim text-slate-900 font-black text-sm md:text-2xl px-4 py-3 md:px-6 md:py-3 rounded-full shadow-[0_5px_20px_rgba(24,169,198,0.6)] mb-0 md:mb-3 flex items-center justify-center animate-bounce border-2 border-[#020617] md:border-none w-full md:w-auto whitespace-nowrap">
            ...
            <div className="flex flex-col items-center w-24 md:w-32">
              ...
              <span className="mt-4 md:mt-5 font-bold text-white text-sm md:text-base">교체 후</span>
            </div>
          </div>
          ...
          <div className="bg-[#050b14] border border-flolim/30 rounded-2xl p-6 md:p-8 text-center max-w-3xl mx-auto shadow-inner relative overflow-hidden z-10 mt-10 md:mt-0">
            ...
            <p className="text-xl md:text-3xl font-light text-white break-keep">
              연간 <strong className="text-flolim font-black text-2xl md:text-4xl mx-1 md:mx-2 drop-shadow-md">{formatNum(savingYear)}원</strong>의 확정 수익 달성!
            </p>
          </div>
        </section>
        ...
        <section className="bg-slate-900/50 backdrop-blur-sm rounded-[2.5rem] p-6 md:p-12 shadow-2xl border border-slate-800 mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            ...
            {/* 효율화 전략 카드 */}
            <div className="bg-[#050b14] p-8 md:p-10 rounded-3xl border border-slate-700 flex flex-col justify-center shadow-inner hover:border-flolim/50 active:border-flolim transition-colors group relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-xl md:text-2xl font-bold text-white mb-6 md:mb-8 group-hover:text-flolim transition-colors">단순 교체를 넘은 2단계 효율화</h3>
                <div className="space-y-6 md:space-y-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-base md:text-lg font-bold text-white mb-1 md:mb-2 break-keep">[LED 교체] 소비전력 60% 절감</h4>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-base md:text-lg font-bold text-white mb-1 md:mb-2 break-keep">[지능형 제어] 20% 추가 절감</h4>
            ...
            {/* Next Step 유도 패널 */}
            <div className="bg-[#050b14] text-white p-8 md:p-10 rounded-3xl shadow-inner border border-slate-700 flex flex-col justify-center relative overflow-hidden group hover:border-flolim/50 active:border-flolim transition-colors cursor-pointer">
              ...
              <div className="relative z-10 text-center md:text-left">
                <div className="inline-block bg-slate-800 text-flolim border border-slate-600 text-[10px] md:text-xs font-bold px-3 md:px-4 py-1 md:py-1.5 rounded-full mb-4 md:mb-6 tracking-wider">
                  도입 안내
                </div>
                ...
                <Link to="/support/contact" className="inline-flex items-center justify-center gap-2 bg-flolim hover:bg-cyan-400 active:scale-95 text-slate-900 font-bold text-base md:text-lg px-6 md:px-8 py-3 md:py-4 rounded-2xl shadow-[0_0_20px_rgba(24,169,198,0.4)] transition-all duration-300 w-full md:w-auto">
                  도입 문의 및 상담 신청
