  ...
  const steps = [
    {
      ...
      desc: (
        <>
          ...
          합니다.
          <br />
          <span className="text-flolim font-bold mt-1 inline-block">
            (귀사 부담 0원)
          </span>
        </>
      ),
    ...
    },
    {
      ...
      desc: (
        <>
          상환 완료 후, 시설물 소유권이 이전되며{" "}
          <strong className="font-medium text-flolim">
            전기료 70% 고정 수익
          </strong>
          (절감액)이 발생합니다.
        </>
        ...
        <section className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-6 md:p-10 lg:p-16 shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
          ...
          <div className="mb-12 md:mb-16 relative z-10">
            ...
            <p className="text-sm md:text-lg text-slate-400 leading-relaxed text-center max-w-4xl mx-auto font-light break-keep">
              ...
              <strong className="font-bold text-white">
                한국전력공사의 자회사 켑코이에스와 공식 파트너십을 체결하고
              </strong>
              , 혁신적인 스마트 조명 에너지 효율화 사업을 진행합니다. 노후
              조명을 고효율 스마트 LED 및 지능형 제어 시스템으로 교체하는 비용{" "}
              <strong className="font-bold text-flolim">
                전액을 켑코이에스에서 선투자
              </strong>
              하므로, 단 1원의 추가 예산 편성 없이 최첨단 인프라를 구축할 수
              있습니다.
            </p>
          </div>
          ...
          <div className="flex items-center justify-center gap-4 md:gap-8 mb-16 md:mb-20 relative z-10 w-full">
            <div className="bg-white p-1.5 md:p-2.5 rounded-xl md:rounded-2xl shadow-lg flex items-center justify-center w-32 h-16 md:w-56 md:h-24 relative z-10 border border-slate-200">
              <img
                src="/images/logo-kepcoes.jpg"
                alt="켑코이에스"
                className="max-h-full max-w-full object-contain"
              />
            </div>
            <div className="text-slate-500 font-black text-xl md:text-3xl shrink-0">
              ×
            </div>
            <div className="bg-white p-1.5 md:p-2.5 rounded-xl md:rounded-2xl shadow-lg flex items-center justify-center w-32 h-16 md:w-56 md:h-24 relative z-10 border border-slate-200">
              <img
                src="/images/logo-flolim.jpg"
                alt="플로림"
                className="max-h-full max-w-full object-contain"
              />
            </div>
          ...
          <div className="mb-20 md:mb-24 relative z-10">
            <div className="text-center mb-8 md:mb-12">
              <h2 className="text-xl md:text-2xl font-bold text-white mb-4 break-keep">
                3단계 도입 및 상환 프로세스
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
              ...
              {steps.map((step) => (
                <div
                  key={step.num}
                  className={`bg-[#050b14] p-6 md:p-8 rounded-3xl text-center shadow-inner hover:-translate-y-1 active:scale-[0.98] transition-all duration-300 group relative overflow-hidden cursor-default ${step.highlight ? "border border-flolim/30 hover:border-flolim" : "border border-slate-700 hover:border-flolim/50"}`}
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 relative z-10">
            <div className="bg-[#050b14] p-8 md:p-10 rounded-3xl border border-slate-700 flex flex-col justify-center shadow-inner hover:border-flolim/50 transition-colors group relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-xl md:text-2xl font-bold text-white mb-6 md:mb-8 group-hover:text-flolim transition-colors break-keep">
                  단순 교체를 넘은 2단계 효율화 전략
                </h3>
                <div className="space-y-6 md:space-y-8">
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-slate-800 border border-slate-600 rounded-xl flex items-center justify-center text-flolim font-black text-lg md:text-xl shrink-0">
                      1
                    </div>
                    <div>
                      <h4 className="text-sm md:text-base font-bold text-white mb-1.5 md:mb-2 break-keep">
                        LED 교체{" "}
                        <span className="text-slate-600 mx-1.5 font-normal">
                          |
                        </span>{" "}
                        소비전력 <span className="text-flolim">60% 절감</span>
                      </h4>
                      <p className="text-slate-400 font-light text-xs md:text-sm leading-relaxed break-keep">
                        기존 60W 노후 조명을 25W 초고효율 스마트 LED로 교체하여
                        하드웨어적인 전력 소모를 대폭 줄입니다.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-flolim/10 border border-flolim/30 rounded-xl flex items-center justify-center text-flolim font-black text-lg md:text-xl shrink-0">
                      2
                    </div>
                    <div>
                      <h4 className="text-sm md:text-base font-bold text-white mb-1.5 md:mb-2 break-keep">
                ...
                <Link
                  ...
                  className="mt-8 md:mt-10 group/btn relative overflow-hidden bg-slate-800 border border-slate-600 rounded-2xl p-5 md:p-6 text-center shadow-lg hover:border-flolim/50 active:scale-[0.98] active:border-flolim transition-all duration-300 block"
                >
                  <p className="text-white font-bold text-sm md:text-base mb-3 group-hover/btn:text-flolim transition-colors break-keep">
                    우리 회사는 얼마나 절감될까?
                  </p>
            ...
            <div className="bg-[#050b14] p-8 md:p-10 rounded-3xl shadow-inner border border-slate-700 flex flex-col justify-center hover:border-flolim/50 transition-colors group relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-400 font-light text-xs md:text-sm leading-relaxed mb-6 md:mb-8 break-keep">
                  초기 투자비 0원으로 구축하는{" "}
                  <strong className="text-flolim font-bold">ESCO 자금</strong>
                  에, 절감된 전력량에 비례하여 한국전력공사에서 현금 지원금을
                  직접 수령하는{" "}
                ...
                <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-4 md:p-5 border border-slate-600 flex items-center gap-3 md:gap-4">
                  ...
                  <div>
                    <span className="block font-bold text-white text-xs md:text-sm mb-0.5 md:mb-1 break-keep">
                      투자 회수율 극대화
                    </span>
                    <span className="text-[10px] md:text-xs text-flolim font-medium break-keep">
                      상환 기간 단축 및 순수익 조기 전환
                    </span>
                  </div>
                </div>
              </div>
