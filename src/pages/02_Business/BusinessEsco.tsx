      ...
      <div className="container mx-auto px-4 max-w-6xl mt-10">
        ...
        <section className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-10 md:p-16 shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
          ...
          <div className="mb-20 relative z-10">
            ...
            <p className="text-base md:text-lg text-slate-400 leading-relaxed text-center max-w-4xl mx-auto font-light">
          ...
          <div className="mb-24 relative z-10">
            <div className="text-center mb-12">
              <h2 className="text-2xl font-bold text-white mb-4">3단계 도입 및 상환 프로세스</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
              ...
              {/* Step 1 카드 (하드코딩) */}
              <div className="bg-[#050b14] p-8 rounded-3xl border border-flolim/30 text-center shadow-inner hover:-translate-y-1 hover:border-flolim transition-all duration-300 group relative overflow-hidden">
                {/* 우측 상단 호버 원형 데코 */}
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-lg font-bold text-white mb-4 group-hover:text-flolim transition-colors">[도입] 초기 투자비 0원</h3>
              ...
              {/* Step 2 카드 (하드코딩) */}
              <div className="bg-[#050b14] p-8 rounded-3xl border border-slate-700 text-center shadow-inner hover:-translate-y-1 hover:border-flolim/50 transition-all duration-300 group relative overflow-hidden">
                {/* 우측 상단 호버 원형 데코 */}
                <div className="absolute -right-6 -top-6 w-24 h-24 bg-flolim/5 rounded-full z-0 group-hover:scale-150 transition-transform duration-700 pointer-events-none"></div>

                <div className="relative z-10">
                  <div className="w-16 h-16 bg-slate-800 text-slate-400 rounded-2xl flex items-center justify-center mx-auto mb-6 text-2xl font-black border border-slate-600 shadow-sm group-hover:bg-flolim/10 group-hover:text-flolim group-hover:border-flolim/50 transition-colors">2</div>
                  <h3 className="text-lg font-bold text-white mb-4 group-hover:text-flolim transition-colors">[상환] 절감액 분할 상환</h3>
                  <p className="text-sm text-slate-400 font-light leading-relaxed">
              ...
              <div className="bg-[#050b14] p-8 rounded-3xl border border-flolim/30 text-center shadow-inner hover:-translate-y-1 hover:border-flolim transition-all duration-300 group relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-lg font-bold text-white mb-4 group-hover:text-flolim transition-colors">[수익] 고정 수익 발생</h3>
                  <p className="text-sm text-slate-400 font-light leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 relative z-10">
            ...
            <div className="bg-[#050b14] p-10 rounded-3xl border border-slate-700 flex flex-col justify-center shadow-inner hover:border-flolim/50 transition-colors group relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-xl font-bold text-white mb-8 group-hover:text-flolim transition-colors">단순 교체를 넘은 2단계 효율화 전략</h3>
                <div className="space-y-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-base font-bold text-white mb-2">[LED 교체] 소비전력 60% 절감</h4>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-base font-bold text-white mb-2">[지능형 제어] 20% 추가 절감</h4>
                ...
                {/* 시뮬레이션 라우팅 버튼 */}
                <Link to="/business/simulation" className="mt-10 group/btn relative overflow-hidden bg-slate-800 border border-slate-600 rounded-2xl p-6 text-center shadow-lg hover:border-flolim/50 transition-all duration-300 block">
                  <p className="text-white font-bold text-base mb-3 group-hover/btn:text-flolim transition-colors">우리 회사는 얼마나 절감될까?</p>
                  <div className="inline-flex items-center gap-2 text-slate-900 bg-flolim px-5 py-2.5 rounded-full text-xs font-bold shadow-md hover:bg-cyan-400 transition-all">
                    맞춤형 시뮬레이션 해보기 
            ...
            {/* ESCO + EERS 결합 카드 (하드코딩) */}
            <div className="bg-[#050b14] p-10 rounded-3xl shadow-inner border border-slate-700 flex flex-col justify-center hover:border-flolim/50 transition-colors group relative overflow-hidden">
              <div className="absolute -right-6 -top-6 w-32 h-32 bg-flolim/5 rounded-full z-0 group-hover:scale-150 transition-transform duration-700 pointer-events-none"></div>
              
              <div className="relative z-10">
                <div className="inline-block bg-slate-800 text-flolim border border-slate-600 text-[10px] font-bold px-3 py-1.5 rounded-full mb-6 uppercase tracking-wider">
                  결합 시너지
                </div>
                <h3 className="text-2xl font-black mb-6 leading-tight text-white group-hover:text-flolim transition-colors">
                ...
                <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-5 border border-slate-600 flex items-center gap-4">
                  <div className="w-12 h-12 rounded-xl bg-flolim/10 flex items-center justify-center text-flolim shrink-0 border border-flolim/30">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                  </div>
                  <div>
                    <span className="block font-bold text-white text-sm mb-1">투자 회수율 극대화</span>
                    <span className="text-xs text-flolim font-medium">상환 기간 평균 3년 단축 및 순수익 조기 전환</span>
                  </div>
                </div>
              </div>
            </div>
