  ...
  const dashboardFeatures = [
    {
      ...
      title: "디지털 트윈 실시간 뷰",
      desc: "현장 조명 배치를 3D 가상 공간에 투영하여 점소등 및 밝기 상태를 직관적으로 모니터링합니다.",
    },
    {
      id: "02",
      icon: (
      ...
      desc: "누적 전력량, 탄소 저감량, 절감 요금을 시각화하여 매월 ESG 경영 리포트의 기반 데이터를 제공합니다.",
    },
    {
      id: "03",
      icon: (
      ...
      title: "실시간 원격 조명 제어",
      desc: "사무실, 로비 등 구역별 조명을 개별/그룹 단위로 원격 토글하고 맞춤형 조명 씬(Scene)을 실행합니다.",
    },
    {
      id: "04",
      icon: (
      ...
      desc: "AI 비전 센서의 재실 감지와 조도 센서의 현재 공간 밝기(Lux) 값을 딜레이 없이 실시간 수집합니다.",
    },
    {
      id: "05",
      icon: (
      ...
      title: "기타 설비 시스템 연동",
      desc: "조명 외에도 냉난방기, 환기 시스템 등 건물 내 기타 기기의 상태를 한곳에서 통합 관제합니다.",
    },
  ];
        ...
        <section className="mb-20 relative z-10">
          <div className="text-center mb-10 md:mb-12 px-2">
            ...
            <p className="text-slate-400 font-light text-xs md:text-base break-keep">
              웹 표준 기반 플랫폼 하나로 수많은 기기를 직관적이고 완벽하게
              통제합니다.
            </p>
          </div>
