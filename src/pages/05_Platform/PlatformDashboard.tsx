      ...
      <div className="container mx-auto px-4 max-w-6xl mt-10">
        ...
        <section className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-10 md:p-16 shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
          ...
          <div className="text-center mb-10 relative z-10">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">실제 관제실 시뮬레이터</h2>
            <p className="text-slate-400 text-sm">현장의 관리자가 된 것처럼, 가로등과 실내 조명 대시보드를 전환해 보세요.</p>
          </div>

          {/* 대시보드 전환 토글 */}
          <div className="flex justify-center mb-10 relative z-10">
            <div className="bg-[#050b14] p-1.5 rounded-2xl inline-flex border border-slate-700 shadow-inner">
              <button 
                onClick={() => setViewMode('city')} 
                className={`px-6 py-3 rounded-xl font-bold text-sm transition-all ${viewMode === 'city' ? 'bg-flolim text-slate-900 shadow-[0_0_15px_rgba(24,169,198,0.4)]' : 'text-slate-400 hover:text-white'}`}
              >
                스마트 가로등 (GIS 기반)
              </button>
              <button 
                onClick={() => setViewMode('building')} 
                className={`px-6 py-3 rounded-xl font-bold text-sm transition-all ${viewMode === 'building' ? 'bg-flolim text-slate-900 shadow-[0_0_15px_rgba(24,169,198,0.4)]' : 'text-slate-400 hover:text-white'}`}
              >
                스마트 조명 (도면 기반)
              </button>
            </div>
          ...
          <div className="relative z-10 max-w-5xl mx-auto mb-6">
            <div className="bg-slate-800 p-3 md:p-4 rounded-t-3xl border-t border-x border-slate-600 shadow-2xl relative">
              {/* 카메라/센서 홀 */}
              <div className="absolute top-1.5 left-1/2 transform -translate-x-1/2 w-2 h-2 bg-slate-950 rounded-full"></div>
              
              {/* 화면 영역 */}
              <div className="relative w-full aspect-video bg-[#0a1128] rounded-xl overflow-hidden border border-slate-900 group">
                {/* 가로등 대시보드 이미지 */}
                <img 
            ...
            {/* 모니터 하단 받침대 느낌 */}
            <div className="h-4 md:h-6 bg-gradient-to-b from-slate-600 to-slate-800 rounded-b-3xl w-full mx-auto shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex justify-center">
              <div className="w-32 h-1 bg-slate-500 rounded-b-md"></div>
            </div>
          </div>
        </section>

        {/* 2. 시스템 주요 기능 요약 (브로슈어 25p 반영) */}
        <section className="mb-20">
          <div className="text-center mb-12 relative z-10">
            <h2 className="text-3xl font-bold text-white">스마트 제어 시스템 주요 기능</h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
            <div className="bg-[#050b14] p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-all group relative overflow-hidden">
              ...
              <h3 className="text-lg font-bold text-white mb-2 group-hover:text-flolim transition-colors relative z-10">원격 제어</h3>
            ...
            <div className="bg-[#050b14] p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-all group relative overflow-hidden">
              ...
              <h3 className="text-lg font-bold text-white mb-2 group-hover:text-flolim transition-colors relative z-10">스마트 자동화</h3>
              <p className="text-slate-400 text-sm font-light leading-relaxed relative z-10">
            ...
            <div className="bg-[#050b14] p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-all group relative overflow-hidden">
              ...
              <h3 className="text-lg font-bold text-white mb-2 group-hover:text-flolim transition-colors relative z-10">실시간 관제</h3>
              <p className="text-slate-400 text-sm font-light leading-relaxed relative z-10">
            ...
            <div className="bg-[#050b14] p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-all group relative overflow-hidden">
              ...
              <h3 className="text-lg font-bold text-white mb-2 group-hover:text-flolim transition-colors relative z-10">분석/보고</h3>
              <p className="text-slate-400 text-sm font-light leading-relaxed relative z-10">
