        ...
        <section className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-10 md:p-16 shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
            ...
            <div className="lg:w-7/12 w-full flex justify-center">
              <div className="relative w-full h-[450px] bg-[#050b14] rounded-3xl shadow-inner overflow-hidden border border-slate-700 flex items-center justify-center p-2">
                ...
                <div className="absolute top-6 left-6 flex items-center gap-2 bg-slate-900/90 backdrop-blur-md px-4 py-2 rounded-lg border border-slate-700 z-20 pointer-events-none shadow-lg">
                  ...
                  <span className="text-[10px] font-bold text-white tracking-widest uppercase">실시간 상용망 관제</span>
                </div>
          ...
          <div className="mb-24 relative z-10">
            <div className="text-center mb-12">
              <h2 className="text-2xl font-bold text-white mb-4">가장 심플하고 강력한 하드웨어 구성</h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[#050b14] p-8 rounded-3xl border border-slate-700 opacity-50 relative overflow-hidden shadow-inner">
                <div className="absolute inset-0 bg-slate-900/80 backdrop-blur-[2px] z-10 flex items-center justify-center">
                  <span className="bg-red-500/20 text-red-400 border border-red-500/50 px-4 py-2 rounded-lg font-bold tracking-widest rotate-[-15deg] shadow-lg">설치 불필요</span>
                </div>
                <div className="flex items-center gap-5 mb-6">
                  <div className="w-14 h-14 bg-slate-800 border border-slate-600 text-slate-500 rounded-2xl flex items-center justify-center text-xl font-black shadow-sm">01</div>
                  <div>
                    <h3 className="text-lg font-bold text-slate-400 line-through decoration-red-500 decoration-2 mb-1">현장을 지휘하는 중계기</h3>
                    <span className="text-slate-500 text-sm font-bold uppercase tracking-wider line-through">IoT Gateway</span>
                  </div>
                </div>
                <p className="text-slate-500 mb-6 font-light leading-relaxed text-sm line-through">
                  현장의 데이터를 모아 관제 서버로 전송하는 복잡한 라우팅 장비나 전용 전봇대가 필요했습니다.
                </p>
              </div>

              <div className="bg-[#050b14] p-8 rounded-3xl border border-flolim/50 shadow-[0_0_30px_rgba(24,169,198,0.1)] transition-all duration-300 group relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-5 mb-6">
                    <div className="w-14 h-14 bg-flolim border border-flolim text-slate-900 rounded-2xl flex items-center justify-center text-xl font-black shadow-lg">01</div>
                    <div>
                      <h3 className="text-lg font-bold text-white mb-1">독립 통신 스마트 단말기</h3>
                  ...
                  <ul className="space-y-3 text-xs text-slate-400 bg-slate-900 p-5 rounded-2xl border border-slate-700">
                    <li className="flex items-start"><svg className="w-4 h-4 text-flolim mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg>단독 설치 및 개별 통신 지원 (외곽 지역 최적화)</li>
                    <li className="flex items-start"><svg className="w-4 h-4 text-flolim mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg>NEMA(외장) 및 ZHAGA(내장) 규격 완벽 지원</li>
                    <li className="flex items-start"><svg className="w-4 h-4 text-flolim mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg>전압, 전류 등 조명 전력 상태 실시간 측정 및 즉각 보고</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="mb-16 relative z-10">
            <h2 className="text-2xl font-bold text-white mb-8 text-center">왜 플로림 NB-IoT 솔루션인가요?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-[#050b14] p-8 rounded-2xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-colors group relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="font-bold text-white mb-2">초기 구축비용 최소화</h3>
              ...
              <div className="bg-[#050b14] p-8 rounded-2xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-colors group relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="font-bold text-white mb-2">전국망 커버리지 지원</h3>
                  <p className="text-slate-400 text-xs font-light leading-relaxed">
                    SKT, KT, LGU+의 거대한 통신 기지국을 사용하므로, 산간 오지나 바닷가 등 휴대폰이 터지는 곳이라면 100% 제어할 수 있습니다.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-[#050b14] p-8 rounded-2xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-colors group relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="font-bold text-white mb-2">최고 수준의 보안성</h3>
                  <p className="text-slate-400 text-xs font-light leading-relaxed">
              ...
              <table className="w-full text-left border-collapse text-xs md:text-sm">
                <tbody>
                  <tr className="border-b border-slate-800">
                    ...
                    <td className="py-4 px-6 text-slate-400 font-light">Up to 250 Kbps / <strong className="text-flolim">거리 무제한 (통신사 기지국 커버리지 내)</strong></td>
                  </tr>
                  <tr className="border-b border-slate-800">
                    <th className="py-4 px-6 bg-slate-900 text-slate-300 font-bold">무선 주파수</th>
                    <td className="py-4 px-6 text-slate-400 font-light">이동통신사 할당 면허 대역 (Licensed Band) 사용으로 간섭 원천 차단</td>
                  </tr>
                  <tr className="border-b border-slate-800">
                    <th className="py-4 px-6 bg-slate-900 text-slate-300 font-bold">네트워크 기술</th>
                    <td className="py-4 px-6 text-slate-400 font-light">3GPP Release 13 기반 협대역 사물인터넷 (NarrowBand-Internet of Things)</td>
                  </tr>
                  <tr className="border-b border-slate-800">
                    <th className="py-4 px-6 bg-slate-900 text-slate-300 font-bold">동작 전압</th>
                    <td className="py-4 px-6 text-slate-400 font-light">단말기 AC 96~264V</td>
                  </tr>
                  <tr>
                    <th className="py-4 px-6 bg-slate-900 text-slate-300 font-bold">통신비</th>
                    <td className="py-4 px-6 text-slate-400 font-light">기기당 소정의 월 통신 요금 발생 (SKT, KT, LGU+ 요금제 기반)</td>
                  </tr>
                </tbody>
              </table>
            </div>
