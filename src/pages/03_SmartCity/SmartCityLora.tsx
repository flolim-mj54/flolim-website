    ...
    <div className="pb-10">
      ...
      <div className="container mx-auto px-4 max-w-6xl mt-10">
        ...
        <section className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-10 md:p-16 shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center mb-24 relative z-10">
            ...
            <div className="lg:w-7/12 w-full flex justify-center">
              <div className="relative w-full h-[450px] bg-[#050b14] rounded-3xl shadow-inner overflow-hidden border border-slate-700 flex items-center justify-center p-2">
                {!import.meta.env.VITE_NAVER_MAP_CLIENT_ID && !isMapLoaded && (
                   <div className="absolute inset-0 flex flex-col items-center justify-center text-slate-400 font-light text-sm z-30">
                     <svg className="w-12 h-12 mb-4 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                     네이버 지도 API 키(.env) 설정이 필요합니다.
                   </div>
                )}
                <div ref={mapContainerRef} className="w-full h-full rounded-2xl overflow-hidden" style={{ filter: 'invert(100%) hue-rotate(180deg) brightness(85%) contrast(110%) grayscale(20%)' }}></div>
                
                <div className="absolute top-6 left-6 flex items-center gap-2 bg-slate-900/90 backdrop-blur-md px-4 py-2 rounded-lg border border-slate-700 z-20 pointer-events-none shadow-lg">
                  <span className="w-2 h-2 bg-flolim rounded-full animate-pulse shadow-[0_0_10px_rgba(24,169,198,1)]"></span>
                  <span className="text-[10px] font-bold text-white tracking-widest">실시간 무선망 관제</span>
                </div>

                <div className="absolute top-6 right-6 flex flex-col gap-2 z-20">
                  <button onClick={handleZoomIn} className="w-10 h-10 bg-slate-900/90 backdrop-blur-md border border-slate-700 text-white rounded-xl shadow-lg flex items-center justify-center hover:text-flolim hover:border-flolim transition-all duration-300">
                  ...
                  <button onClick={handleZoomOut} className="w-10 h-10 bg-slate-900/90 backdrop-blur-md border border-slate-700 text-white rounded-xl shadow-lg flex items-center justify-center hover:text-flolim hover:border-flolim transition-all duration-300">
          ...
          {/* 2. 시스템 구성 요소 (브로슈어 15p) */}
          <div className="mb-24 relative z-10">
            <div className="text-center mb-12">
              <h2 className="text-2xl font-bold text-white mb-4">스마트 가로등 핵심 하드웨어 구성</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[#050b14] p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-all duration-300 group relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-5 mb-6">
                    <div className="w-14 h-14 bg-slate-800 border border-slate-600 text-flolim rounded-2xl flex items-center justify-center text-xl font-black shadow-sm group-hover:bg-flolim/10 transition-colors">01</div>
                    <div>
                      <h3 className="text-lg font-bold text-white mb-1">현장을 지휘하는 게이트웨이</h3>
                  ...
                  <ul className="space-y-3 text-xs text-slate-300 bg-slate-900 p-5 rounded-2xl border border-slate-700">
                    <li className="flex items-start"><svg className="w-4 h-4 text-flolim mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg>관제 서버와의 빠르고 안정적인 양방향 통신 지원</li>
                    <li className="flex items-start"><svg className="w-4 h-4 text-flolim mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg>전력 사용량을 원격으로 측정하는 스마트 미터기 기능</li>
                    <li className="flex items-start"><svg className="w-4 h-4 text-flolim mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg>수만 개의 단말기를 위한 대규모 확장 인터페이스 제공</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-[#050b14] p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-all duration-300 group relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-5 mb-6">
                    <div className="w-14 h-14 bg-slate-800 border border-slate-600 text-flolim rounded-2xl flex items-center justify-center text-xl font-black shadow-sm group-hover:bg-flolim/10 transition-colors">02</div>
                    <div>
                      <h3 className="text-lg font-bold text-white mb-1">무선 스마트 단말기</h3>
                      <span className="text-flolim text-sm font-bold uppercase tracking-wider">Lamp Controller</span>
                    </div>
                  </div>
                  <p className="text-slate-400 mb-6 font-light leading-relaxed text-sm">
                    조명 상단이나 내부에 직접 장착되어 제어 명령을 정확하게 수행하고, 현재 램프의 상태를 서버에 보고합니다.
                  </p>
                  <ul className="space-y-3 text-xs text-slate-300 bg-slate-900 p-5 rounded-2xl border border-slate-700">
                    <li className="flex items-start"><svg className="w-4 h-4 text-flolim mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg>NEMA 7핀(외장) 및 ZHAGA 4핀(내장) 표준 규격 지원</li>
                    <li className="flex items-start"><svg className="w-4 h-4 text-flolim mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg>주변 환경에 맞춘 세밀한 밝기 조절(디밍) 제어</li>
                    <li className="flex items-start"><svg className="w-4 h-4 text-flolim mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg>전압, 전류 등 조명의 전력 상태 실시간 측정 및 고장 감지</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="mb-16 relative z-10">
            <h2 className="text-2xl font-bold text-white mb-8 text-center">왜 플로림 LoRa-Mesh 솔루션인가요?</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-[#050b14] p-8 rounded-2xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-colors group relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 bg-slate-800 rounded-xl flex items-center justify-center text-flolim mb-5 border border-slate-600">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                  </div>
                  <h3 className="font-bold text-white mb-2">통신비 평생 무료</h3>
                  <p className="text-slate-400 text-xs font-light leading-relaxed">
                    통신사 망을 빌려 쓰지 않고 자체망을 구축하므로, 수만 개의 단말기를 연결해도 매월 통신 요금이 전혀 발생하지 않습니다.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-[#050b14] p-8 rounded-2xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-colors group relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="font-bold text-white mb-2">고장 사전 예측 진단</h3>
                  <p className="text-slate-400 text-xs font-light leading-relaxed">
                    램프 수명 저하, 누전 등 문제가 발생하기 전 미세한 전력 변화를 즉각적으로 감지하여 대시보드 화면에 경고 알림을 띄웁니다.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-[#050b14] p-8 rounded-2xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-colors group relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="font-bold text-white mb-2">무선 원격 업데이트</h3>
                  <p className="text-slate-400 text-xs font-light leading-relaxed">
                    새로운 제어 기능이 추가되거나 시스템 개선이 필요할 때, 현장에 갈 필요 없이 원격에서 쉽고 안전하게 무선(OTA) 업그레이드합니다.
                  </p>
                </div>
              </div>
            </div>
          ...
          {/* 4. 제품 기술 사양 */}
          <div className="relative z-10 border-t border-slate-800 pt-12">
            <h2 className="text-lg font-bold text-white mb-6 px-2 border-l-4 border-flolim">제품 기술 사양</h2>
            <div className="bg-[#050b14] rounded-2xl border border-slate-700 overflow-hidden shadow-inner">
              <table className="w-full text-left border-collapse text-xs md:text-sm">
                <tbody>
                  <tr className="border-b border-slate-800">
                    <th className="py-4 px-6 bg-slate-900 text-slate-300 font-bold w-1/3 md:w-1/4">통신 속도 / 거리</th>
                    <td className="py-4 px-6 text-slate-400 font-light">256 Kbps / 노드 간 최대 150m, 넓은 지역 기준 1~3km (Mesh 확장 시)</td>
                  </tr>
                  <tr className="border-b border-slate-800">
                    <th className="py-4 px-6 bg-slate-900 text-slate-300 font-bold">무선 주파수</th>
                    <td className="py-4 px-6 text-slate-400 font-light">915MHz 대역 (10개 채널) / 2.4GHz 대역 (16개 채널) 지원</td>
                  </tr>
                  <tr className="border-b border-slate-800">
                    <th className="py-4 px-6 bg-slate-900 text-slate-300 font-bold">네트워크 기술</th>
                    <td className="py-4 px-6 text-slate-400 font-light">IEEE 802.15.4 / 자가 그룹화(Self-Grouping) MESH 네트워크</td>
                  </tr>
                  <tr className="border-b border-slate-800">
                    <th className="py-4 px-6 bg-slate-900 text-slate-300 font-bold">동작 전압</th>
                    <td className="py-4 px-6 text-slate-400 font-light">단말기 AC 96~264V (집중기 최대 500VAC 지원)</td>
                  </tr>
                  <tr>
                    <th className="py-4 px-6 bg-slate-900 text-slate-300 font-bold">전력 소비</th>
                    <td className="py-4 px-6 text-slate-400 font-light">기기당 약 2W 내외의 초저전력 구동</td>
                  </tr>
                </tbody>
              </table>
            </div>
