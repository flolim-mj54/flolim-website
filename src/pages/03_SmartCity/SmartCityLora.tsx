  ...
  const hardwares = [
    {
      ...
      desc: "현장의 수많은 노드 데이터를 수집하여 관제 서버로 실시간 전송합니다. 대규모 스마트 가로등 자가망 구축을 위한 핵심 데이터 집중기(Centralized Controller)입니다.",
      specs: [
        { label: "통신 방식", value: "LoRa-MESH 무선망 및 4G/LTE 백홀 지원" },
        {
          label: "주요 기능",
          value: "다수의 컨트롤러 데이터 취합 및 원격 모니터링",
        },
        {
          label: "특징",
          value: "실시간 구역 제어 활성화 및 대규모 에너지 분석 처리",
        },
      ],
    },
    {
      ...
      desc: "가로등에 장착되어 양방향 통신을 통해 개별 제어 및 상태 모니터링을 수행합니다. 주변 환경을 감지하고 스스로 우회 경로를 찾는 강력한 Mesh 통신 기능을 탑재했습니다.",
      specs: [
        {
          label: "센서 연동",
          value: "주변광 및 모션 센서 연동을 통한 적응형 디밍",
        },
        {
          label: "네트워크",
          value: "높은 EMI 복원력, 노드 간 끊김 없는 데이터 중계",
        },
        {
          label: "구조 설계",
          value: "외부 안테나를 통한 송수신 거리 확장 및 안정성 극대화",
        },
      ],
    },
    {
      ...
      desc: "단일 가로등 기구의 LED 드라이버와 직접 연결되어 정밀한 개별 점·소등 및 모니터링을 수행하는 소형 컨트롤러입니다.",
      specs: [
        {
          label: "적용 형태",
          value: "단일 램프(Single Lamp) 개별 제어 및 상태 진단 특화",
        },
        {
          label: "제어 기능",
          value: "중앙 플랫폼을 통한 원격 ON/OFF 및 조도 스케줄링",
        },
        {
          label: "상태 보고",
          value: "램프 고장, 전압 강하 등 오류 실시간 감지 및 알림",
        },
      ],
    },
    {
      ...
      desc: "컨트롤러의 신호를 받아 LED 조명의 밝기를 0~100%까지 세밀하게 조절합니다. 시스템에 최적화되어 높은 에너지 효율과 안정적인 전력 공급을 보장합니다.",
      specs: [
        {
          label: "디밍 인터페이스",
          value: "DALI 및 0-10V 정밀 조도 제어 완벽 지원",
        },
        {
          label: "내구성",
          value: "과열/과전압 보호, 외부 충격 및 노이즈 방지 설계",
        },
        {
          label: "효율성",
          value: "적응형 제어와 결합하여 LED 수명 100,000시간 연장 기여",
        },
      ],
    },
  ];
  ...
  const benefits = [
    {
      ...
      title: "통신비 평생 무료",
      desc: "통신사 망을 빌려 쓰지 않고 자체망을 구축하므로, 수만 개의 컨트롤러를 연결해도 매월 통신 요금이 전혀 발생하지 않습니다.",
    },
    {
      id: 2,
      icon: (
      ...
      title: "실시간 고장 감지",
      desc: "램프 고장시 즉각 감지하여 대시보드 화면에 경고 알림을 띄웁니다.",
    },
    {
      id: 3,
      icon: (
      ...
      title: "통신 공사 비용 절감",
      desc: "복잡한 통신선 매설이 필요 없는 100% 무선 시스템으로 초기 통신 공사 비용과 시간을 획기적으로 단축합니다.",
    },
    {
      id: 4,
      icon: (
      ...
      title: "맞춤식 관제 UI 제공",
      desc: "고객사의 현장 상황과 요구사항에 완벽하게 맞춰진, 직관적이고 편리한 커스텀 대시보드 인터페이스를 제공합니다.",
    },
  ];
          ...
          <div className="flex flex-col lg:flex-row gap-8 md:gap-12 items-center mb-20 md:mb-24 relative z-10">
            <div className="lg:w-5/12">
              ...
              <p className="text-slate-400 leading-relaxed mb-6 font-light text-xs md:text-base break-keep">
                플로림의 LoRa-Mesh 솔루션은 저전력 장거리 통신(LoRa) 기술과
                그물망(Mesh) 구조의 장점을 완벽하게 결합한 차세대 도로조명
                제어망입니다. 각 가로등에 설치된 컨트롤러가 스스로 중계기 역할을
                수행하여 통신 도달 거리와 안정성을 극대화합니다.
              </p>
              <div className="bg-[#050b14] border-l-4 border-flolim p-4 md:p-5 rounded-r-xl shadow-inner">
                <p className="text-[11px] md:text-sm text-slate-300 font-medium leading-relaxed break-keep">
                  특정 컨트롤러에 고장이 발생하더라도 주변 가로등을 통해{" "}
                  <strong className="text-flolim">
                    메인 게이트웨이로 가는 우회 경로를 자동 탐색
                  </strong>
                  합니다. 건물이나 산악 지형으로 인한 통신 음영 지역을
                  해소합니다.
                </p>
              </div>
            </div>
                ...
                <tbody>
                  <tr className="border-b border-slate-800">
                    ...
                    <td className="py-3 px-4 md:py-4 md:px-6 text-slate-400 font-light">
                      256 Kbps / 노드 간 최대 150m, 넓은 지역 기준 1~3km (Mesh
                      확장 시)
                    </td>
                  </tr>
                  <tr className="border-b border-slate-800">
                  ...
                  <tr className="border-b border-slate-800">
                    ...
                    <td className="py-3 px-4 md:py-4 md:px-6 text-slate-400 font-light">
                      IEEE 802.15.4 / 자가 그룹화(Self-Grouping) MESH 네트워크
                    </td>
                  </tr>
                  <tr className="border-b border-slate-800">
                    <th className="py-3 px-4 md:py-4 md:px-6 bg-slate-900 text-slate-300 font-bold">
                    ...
                    <td className="py-3 px-4 md:py-4 md:px-6 text-slate-400 font-light">
                      컨트롤러 AC 96~264V (게이트웨이 최대 500VAC 지원)
                    </td>
                  </tr>
                  <tr>
                    <th className="py-3 px-4 md:py-4 md:px-6 bg-slate-900 text-slate-300 font-bold">
