        ...
        <section className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-6 md:p-10 lg:p-16 shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
          ...
          <div className="mb-20 md:mb-24 relative z-10">
            <div className="text-center mb-8 md:mb-12 px-2">
              <h2 className="text-xl md:text-3xl font-bold text-white mb-2 md:mb-4 break-keep">왜 DMX 솔루션이 필요한가요?</h2>
              <p className="text-slate-400 font-light text-xs md:text-sm break-keep">일반 조명과 플로림 DMX 스마트 조명의 결정적 차이를 눈으로 확인하세요.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 relative">
              ...
              <div className="bg-[#050b14] rounded-3xl border border-slate-700 overflow-hidden flex flex-col grayscale-[20%] opacity-80 shadow-inner group">
                <div className="p-4 md:p-6 border-b border-slate-700 bg-slate-900 flex justify-between items-center relative z-10">
                  <h3 className="text-base md:text-lg font-bold text-slate-300 break-keep">기존 일반 경관 조명</h3>
                  <span className="text-[10px] md:text-xs font-bold text-slate-500 bg-slate-800 px-3 py-1.5 rounded-lg border border-slate-700 whitespace-nowrap">단방향 제어</span>
                </div>
                ...
                <div className="p-6 md:p-8 grow bg-slate-900/30 relative z-10">
                  <ul className="space-y-3 md:space-y-4">
                    <li className="flex items-start gap-2 md:gap-3">
                      <svg className="w-4 h-4 md:w-5 md:h-5 text-slate-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                      <span className="text-slate-400 text-xs md:text-sm break-keep">전체를 한 번에 켜고 끄는 단순 제어만 가능</span>
                    </li>
                    <li className="flex items-start gap-2 md:gap-3">
                      <svg className="w-4 h-4 md:w-5 md:h-5 text-slate-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                      <span className="text-slate-400 text-xs md:text-sm break-keep">단일 색상으로 밋밋하고 정적인 야경 연출</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-[#050b14] rounded-3xl border border-flolim/40 shadow-[0_0_30px_rgba(24,169,198,0.15)] overflow-hidden flex flex-col relative transform lg:scale-105 z-10 transition-transform duration-300 group hover:border-flolim/60">
                ...
                <div className="relative z-10 p-4 md:p-6 border-b border-slate-700 bg-slate-900 flex justify-between items-center">
                  <h3 className="text-base md:text-lg font-bold text-white flex items-center gap-2 break-keep">
                    <svg className="w-4 h-4 md:w-5 md:h-5 text-flolim" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                    플로림 DMX512 제어
                  </h3>
                  ...
                  <ul className="space-y-3 md:space-y-4">
                    <li className="flex items-start gap-2 md:gap-3">
                      <div className="w-4 h-4 md:w-5 md:h-5 rounded-md bg-flolim/20 flex items-center justify-center shrink-0 mt-0.5 border border-flolim/40">
                        <svg className="w-2.5 h-2.5 md:w-3 md:h-3 text-flolim" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg>
                      </div>
                      <div>
                        <strong className="text-white text-xs md:text-sm block mb-1 break-keep">조명 하나하나를 픽셀 단위로 개별 제어</strong>
                        <span className="text-slate-400 text-[10px] md:text-xs break-keep">수백 개의 조명을 마치 모니터 화면처럼 정밀하게 통제합니다.</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-2 md:gap-3">
                      <div className="w-4 h-4 md:w-5 md:h-5 rounded-md bg-flolim/20 flex items-center justify-center shrink-0 mt-0.5 border border-flolim/40">
                      ...
                      <div>
                        <strong className="text-white text-xs md:text-sm block mb-1 break-keep">1,600만 가지 풀컬러 및 동적 애니메이션</strong>
                        <span className="text-slate-400 text-[10px] md:text-xs break-keep">빛이 흐르고 파도치는 화려한 미디어 파사드를 연출합니다.</span>
                      </div>
                    </li>
                  </ul>
                </div>
                ...
                <div className="flex items-center justify-between relative z-10">
                  <div className="flex flex-col items-center">
                    <div className="w-10 h-10 md:w-14 md:h-14 bg-slate-800 border-2 border-flolim rounded-xl flex items-center justify-center shadow-[0_0_15px_rgba(24,169,198,0.5)] z-10 relative">
                      <svg className="w-5 h-5 md:w-6 md:h-6 text-flolim" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path></svg>
                    </div>
                    <span className="text-[9px] md:text-[10px] font-bold text-white mt-2 md:mt-3 tracking-wider whitespace-nowrap">메인 컨트롤러</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-[8px] md:text-[9px] text-slate-500 mt-2 font-mono whitespace-nowrap">채널 1</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-slate-800 border border-slate-600 rounded-full flex items-center justify-center z-10 relative">
                      <div className="w-3 h-3 md:w-4 md:h-4 rounded-full bg-blue-500 shadow-[0_0_10px_#3b82f6] animate-pulse" style={{animationDelay: '0.5s'}}></div>
                    </div>
                    <span className="text-[8px] md:text-[9px] text-slate-500 mt-2 font-mono whitespace-nowrap">채널 2</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-slate-800 border border-slate-600 rounded-full flex items-center justify-center z-10 relative">
                      <div className="w-3 h-3 md:w-4 md:h-4 rounded-full bg-flolim shadow-[0_0_10px_#18A9C6] animate-pulse" style={{animationDelay: '1s'}}></div>
                    </div>
                    <span className="text-[8px] md:text-[9px] text-slate-500 mt-2 font-mono whitespace-nowrap">채널 3</span>
                  </div>
                </div>
                <style>
                  {`
