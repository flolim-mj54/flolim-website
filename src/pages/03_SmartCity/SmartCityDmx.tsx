  ...
  const hardwareList = [
    {
      ...
      desc: "수백 개의 조명을 지연 없이 동시에 지휘하는 '시스템의 두뇌'입니다. 복잡한 빛의 움직임과 색상 변화를 한 치의 오차 없이 통제합니다.",
      specs: [
        { label: "역할", value: "대규모 미디어 파사드 및 경관 조명 총괄 제어" },
        {
          label: "성능",
          value: "수천 개의 채널을 0.01초 딜레이 없이 동시 조절",
        },
        {
          label: "특징",
          value: "직관적인 조작 화면으로 현장 세팅이 매우 간편",
        },
      ],
    },
    {
      ...
      desc: "간판이나 건물 테두리의 띠 조명(LED바) 색상을 물 흐르듯 연출합니다. 1,600만 가지 색상을 끊김 없이 부드럽게 바꿔주는 역할을 합니다.",
      specs: [
        {
          label: "주요 용도",
          value: "라인 조명, 간판 조명 등의 색상/밝기 제어",
        },
        {
          label: "표현력",
          value: "계단 현상 없는 아주 부드러운 색상 변화 지원",
        },
        {
          label: "안전",
          value: "과전류 및 합선 시 전원을 자동으로 차단하여 보호",
        },
      ],
    },
    {
      ...
      desc: "멀리 쏘는 강력한 서치라이트나 투광기의 빛 세기를 안전하게 조절합니다. 고출력 조명 기구에 맞춰 전기량을 세밀하게 맞춰주는 똑똑한 제어기입니다.",
      specs: [
        {
          label: "주요 용도",
          value: "고출력 투광등, 조형물 조명 등의 정밀 제어",
        },
        {
          label: "맞춤형",
          value: "사용하는 조명 사양에 맞춰 출력 전기량 수동 설정",
        },
        {
          label: "안정성",
          value: "열 발생을 최소화하여 조명 기구의 수명 보호",
        },
      ],
    },
  ];
            ...
            <div className="bg-[#050b14] rounded-3xl p-8 md:p-10 border border-slate-700 flex flex-col md:flex-row items-center gap-8 md:gap-12 shadow-inner group overflow-hidden">
              ...
              <div className="md:w-1/2 relative z-10">
                ...
                <p className="text-slate-400 leading-relaxed mb-4 md:mb-6 font-light text-xs md:text-sm break-keep">
                  DMX512 기술은 '데이지 체인' 방식으로 조명을 잇습니다. 중앙에서
                  시작된 단 한 줄의 케이블이 수백 개의 조명을 꼬리에 꼬리를 물고
                  연결합니다.
                </p>
                <p className="text-slate-400 leading-relaxed font-light text-xs md:text-sm break-keep">
                  ...
                  <strong className="text-white">초고속 실시간 반응</strong>을
                  자랑합니다.
                </p>
              </div>
              <div className="md:w-1/2 w-full bg-slate-900 p-6 md:p-8 rounded-2xl border border-slate-700 relative shadow-lg z-10">
                ...
                <style>{`@keyframes translateX { 0% { transform: translateX(-100%); } 100% { transform: translateX(500%); } }`}</style>
              </div>
            </div>
          </div>
