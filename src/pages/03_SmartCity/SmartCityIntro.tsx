    ...
    },
    {
      ...
      icon: (
        <path
          ...
          strokeLinejoin="round"
          strokeWidth="1.5"
          d="M14.25 9.666a2.25 2.25 0 112.64 3.63H3m12-9.666a2.25 2.25 0 10-2.64 3.63H3m15.75 11.25a2.25 2.25 0 11-2.64-3.63H3"
        />
      ),
    },
    {
      ...
      icon: (
        <>
          ...
          <path
            ...
            strokeLinejoin="round"
            strokeWidth="1.5"
            d="M12 21a5.25 5.25 0 01-5.25-5.25v-8.5a5.25 5.25 0 0110.5 0v8.5A5.25 5.25 0 0112 21z"
          />
        </>
      ),
    },
  ...
  const cases = [
    {
      id: 1,
      region: "경기도 안산시 실증",
      location: "안산스마트허브 (1,594개 교체)",
      percent: "70",
      label: "감축",
      desc: "통행량 분석 IoT 조명제어 장치 적용으로 에너지 및 탄소 배출을 70% 감축했습니다.",
    },
    {
      id: 2,
      region: "서울시 강남 4구 실증",
      location: "유동 인구 밀집 도로 (1,500개)",
      prefix: "최소",
      percent: "50",
      label: "이상 절감",
      desc: "유동 인구가 많은 지역에서도 스마트 제어를 통해 총 912MW의 에너지를 절약했습니다.",
    },
    {
      id: 3,
      region: "서울시 금천구 G밸리",
      location: "도심지 도로변 (601개 구축)",
      prefix: "연간",
      percent: "60,000",
      unit: "kWh",
      desc: "심야 시간대 및 교통량 연동 자동 조도 조절을 통해 막대한 전력 요금과 예산을 절감했습니다.",
    },
  ];
      ...
      <div className="container mx-auto px-4 max-w-6xl mt-10">
            ...
            <div className="lg:w-1/2 flex flex-col justify-center">
              <h2 className="text-xl md:text-3xl font-bold text-white mb-4 md:mb-6 leading-tight break-keep">
                ...
                <span className="text-flolim">
                  스스로 판단하고 에너지를 최적화합니다
                </span>
              </h2>

              <div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
                <p className="text-slate-400 leading-relaxed font-light text-xs md:text-sm lg:text-base break-keep">
                  플로림의 스마트 시티 솔루션은 단순한 조명 점소등을 넘어,
                  도로의 가로등과 보안등을 원격으로 제어하고 감시하는 완벽한
                  양방향 지능형 시스템입니다.
                </p>
                <p className="text-slate-400 leading-relaxed font-light text-xs md:text-sm lg:text-base break-keep">
                  각 스마트 가로등에 탑재된 IoT 기반 센서로 주변 환경을 감지하여
                  밝기를 자동으로 조절하고, 수집된 데이터를 분석하여 도시의
                  에너지를 가장 효율적으로 관리하는 인프라를 구축합니다.
                </p>
              </div>
              ...
              <div className="pt-6 md:pt-8 border-t border-slate-700/50">
                <ul className="space-y-3 md:space-y-4 text-slate-300 text-xs md:text-sm font-light bg-[#050b14] p-5 md:p-7 rounded-2xl md:rounded-3xl border border-slate-700 shadow-inner">
                  <li className="flex items-start gap-3">
                    <svg
                      className="w-4 h-4 md:w-5 md:h-5 text-flolim shrink-0 mt-0.5"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <span className="flex-1 leading-relaxed break-keep">
                      관제 서버와의 양방향 통신 및 현장 센싱 데이터 실시간
                      수집·송신
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span className="flex-1 leading-relaxed break-keep">
                      차량/보행자 통행량 및 환경 센서 기반의 지능형 자동 조도
                      조절
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span className="flex-1 leading-relaxed break-keep">
                      수집된 빅데이터 분석을 통한 도시 에너지 최적화 시나리오
                      구현
                    </span>
                  </li>
                </ul>
            ...
            <div className="lg:w-1/2 w-full flex flex-col items-center justify-center">
              <div className="relative w-full aspect-square md:aspect-[4/3] bg-[#050b14] rounded-2xl md:rounded-3xl border border-slate-700 overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] group">
                ...
                <div className="absolute top-4 right-4 md:top-6 md:right-6 z-10 flex items-center gap-2 bg-slate-900/80 backdrop-blur-md px-3 py-1.5 md:px-4 md:py-2 rounded-lg md:rounded-xl border border-slate-700 shadow-lg">
                  ...
                  <span className="text-[10px] md:text-[11px] font-bold text-white tracking-widest">
                    스마트 시티 인프라
                  </span>
                </div>
              </div>
        ...
        <section className="mb-20 md:mb-24 relative z-10">
          <div className="text-center mb-10 md:mb-12 px-2">
            ...
            <p className="text-slate-400 font-light text-xs md:text-base break-keep">
              스마트 가로등에 탑재된 4가지 핵심 센서가 시스템에 실시간 데이터를
              전달합니다.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 relative z-10">
            {sensors.map((s) => (
              <div
                key={s.id}
                className="bg-[#050b14] p-6 md:p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/50 active:scale-[0.98] transition-all duration-300 group relative overflow-hidden flex flex-col sm:flex-row gap-5 md:gap-6 items-center cursor-default"
              >
                ...
                <div className="relative z-10 text-center sm:text-left">
                  ...
                  <p
                    className="text-xs md:text-sm text-slate-400 leading-relaxed font-light break-keep"
        ...
        <section className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-8 md:p-16 shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
          ...
          <div className="text-center mb-10 md:mb-12 relative z-10 px-2">
            <h2 className="text-xl md:text-3xl font-bold text-white mb-3 md:mb-4 break-keep">
              기존 조명 대비 50~70%
              <br className="md:hidden" /> 에너지 절감 및 탄소 배출 감축을
              실현합니다
            </h2>
            <p className="text-slate-400 text-xs md:text-lg font-light break-keep">
              눈에 보이는 수치로 증명합니다. 매월 청구되는 에너지 비용과
              유지보수 예산을 획기적으로 낮춥니다.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 relative z-10">
            {cases.map((c) => (
              <div
                key={c.id}
                className="bg-[#050b14] p-6 md:p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/40 active:scale-[0.98] transition-all duration-300 group relative overflow-hidden flex flex-col h-full cursor-default"
              >
                <div className="absolute -right-6 -top-6 w-24 h-24 bg-flolim/5 rounded-full z-0 group-hover:scale-150 transition-transform duration-700 pointer-events-none"></div>
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <p className="text-[11px] md:text-sm text-slate-500 font-medium mb-6 break-keep flex-grow">
                    {c.location}
                  </p>
                  ...
                  <div className="flex flex-wrap items-end gap-x-2 gap-y-1 mt-auto mb-4">
                    ...
                    {c.label && (
                      <span className="text-slate-400 font-bold mb-1 text-xs md:text-base whitespace-nowrap">
                        {c.label}
                      </span>
                    )}
                  </div>
        ...
        <section className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-8 md:p-16 shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
          <div className="text-center mb-10 md:mb-12 relative z-10 px-2">
            <h2 className="text-xl md:text-2xl font-bold text-white mb-3 md:mb-4 break-keep">
              시스템 구축을 위한 맞춤형 통신 솔루션
            </h2>
            <p className="text-slate-400 font-light text-xs md:text-base leading-relaxed break-keep">
              플로림 제어 시스템은 센서 데이터를 관제 센터로 끊김 없이 전달하기
              위해,
              <br className="hidden md:block" />
              현장의 지형과 시스템 규모에 맞춘 세 가지 하이브리드 통신 솔루션을
              제공합니다.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 w-full relative z-10">
            <FeatureCard
              ...
              title="LoRa-Mesh 솔루션"
              description="매월 통신비 부담 없이, 수만 개의 조명을 촘촘하게 잇는 고신뢰성 무선 메시 네트워크 시스템"
              linkText="자세히 보기"
            />
            <FeatureCard
