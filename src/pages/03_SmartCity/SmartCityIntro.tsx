      ...
      <div className="container mx-auto px-4 max-w-6xl mt-10">
        ...
        <section className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-8 md:p-16 shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center relative z-10">
            <div className="lg:w-1/2 flex flex-col justify-center">
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-6 leading-tight break-keep">
                모든 인프라가 하나로 연결되어<br />
              ...
              <div className="pt-8 border-t border-slate-700/50">
                <ul className="space-y-4 text-slate-300 text-sm font-light bg-[#050b14] p-6 md:p-7 rounded-3xl border border-slate-700 shadow-inner">
        ...
        <section className="mb-20 md:mb-24 relative z-10">
          <div className="text-center mb-10 md:mb-12 px-4">
            {/* 💡 [수정] 태블릿 및 모바일 환경에서 어색한 줄바꿈 방지를 위한 <br className="lg:hidden" /> 및 break-keep 추가 */}
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-3 md:mb-4 break-keep">
              단일 가로등 하나로 <br className="lg:hidden" />
              에너지 절감부터 환경 감시까지 완성합니다
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 relative z-10">
            <div className="bg-[#050b14] p-6 md:p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-all duration-300 group relative overflow-hidden flex flex-col sm:flex-row gap-5 md:gap-6 items-center">
            ...
            <div className="bg-[#050b14] p-6 md:p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-all duration-300 group relative overflow-hidden flex flex-col sm:flex-row gap-5 md:gap-6 items-center">
              ...
              <div className="relative z-10 w-16 h-16 md:w-20 md:h-20 shrink-0 bg-slate-900 rounded-2xl border border-slate-700 flex items-center justify-center overflow-hidden">
                <div className="absolute w-10 h-10 md:w-12 md:h-12 border border-teal-400/30 rounded-full animate-[ping_3s_linear_infinite]"></div>
                <svg className="w-7 h-7 md:w-8 md:h-8 text-teal-400 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M14.25 9.666a2.25 2.25 0 112.64 3.63H3m12-9.666a2.25 2.25 0 10-2.64 3.63H3m15.75 11.25a2.25 2.25 0 11-2.64-3.63H3"></path></svg>
              </div>
              <div className="relative z-10 text-center sm:text-left">
            ...
            <div className="bg-[#050b14] p-6 md:p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-all duration-300 group relative overflow-hidden flex flex-col sm:flex-row gap-5 md:gap-6 items-center">
              ...
              <div className="relative z-10 w-16 h-16 md:w-20 md:h-20 shrink-0 bg-slate-900 rounded-2xl border border-slate-700 flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute top-1/2 left-1/2 w-8 h-8 md:w-10 md:h-10 origin-bottom-left animate-[spin_3s_linear_infinite] bg-gradient-to-br from-cyan-400/40 to-transparent rounded-tr-full"></div>
                <svg className="w-7 h-7 md:w-8 md:h-8 text-cyan-400 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M8.288 15.038a5.25 5.25 0 017.424 0M5.106 11.856c3.807-3.808 9.98-3.808 13.788 0M1.924 8.674c5.565-5.565 14.587-5.565 20.152 0M12.53 18.22l-.53.53-.53-.53a.75.75 0 011.06 0z"></path></svg>
              </div>
              <div className="relative z-10 text-center sm:text-left">
            ...
            <div className="bg-[#050b14] p-6 md:p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-all duration-300 group relative overflow-hidden flex flex-col sm:flex-row gap-5 md:gap-6 items-center">
              ...
              <div className="relative z-10 w-16 h-16 md:w-20 md:h-20 shrink-0 bg-slate-900 rounded-2xl border border-slate-700 flex items-center justify-center overflow-hidden">
                <div className="absolute w-8 h-8 md:w-10 md:h-10 border border-sky-400/50 rounded-full border-dashed animate-[spin_4s_linear_infinite]"></div>
                <svg className="w-7 h-7 md:w-8 md:h-8 text-sky-400 relative z-10 transition-transform duration-1000 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-8 md:p-16 shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
          <div className="text-center mb-10 md:mb-12 relative z-10 px-2">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-3 md:mb-4 break-keep">기존 조명 대비 50~70%<br className="md:hidden" /> 에너지 절감 및 탄소 배출 감축을 실현합니다</h2>
            <p className="text-slate-400 text-sm md:text-lg font-light break-keep">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
            ...
            <div className="bg-[#050b14] p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/40 transition-all duration-300 group relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-flolim transition-colors break-keep">경기도 안산시 실증</h3>
                <p className="text-xs md:text-sm text-slate-500 font-medium mb-6 break-keep">안산스마트허브 (1,594개 교체)</p>
            ...
            <div className="bg-[#050b14] p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/40 transition-all duration-300 group relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-flolim transition-colors break-keep">서울시 강남 4구 실증</h3>
                <p className="text-xs md:text-sm text-slate-500 font-medium mb-6 break-keep">유동 인구 밀집 도로 (1,500개)</p>
                <div className="flex items-end gap-2 mb-4">
            ...
            <div className="bg-[#050b14] p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/40 transition-all duration-300 group relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-flolim transition-colors break-keep">서울시 금천구 G밸리</h3>
                <p className="text-xs md:text-sm text-slate-500 font-medium mb-6 break-keep">도심지 도로변 (601개 구축)</p>
                <div className="flex items-end gap-2 mb-4">
        ...
        <section className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-8 md:p-16 shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
          <div className="text-center mb-10 md:mb-12 relative z-10">
            <h2 className="text-2xl font-bold text-white mb-4 break-keep">시스템 구축을 위한 맞춤형 통신 솔루션</h2>
            <p className="text-slate-400 font-light text-sm md:text-base leading-relaxed break-keep">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full relative z-10">
            ...
            {/* 💡 [수정] 모바일 터치 피드백 active:scale-[0.98] 추가 */}
            <Link to="/smart-city/lora" className="bg-[#050b14] p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim hover:bg-slate-800/80 active:scale-[0.98] active:border-flolim transition-all duration-300 group hover:-translate-y-2 flex flex-col h-full cursor-pointer relative overflow-hidden">
              <div className="absolute -right-6 -top-6 w-24 h-24 bg-flolim/5 rounded-full z-0 group-hover:scale-150 transition-transform duration-700 pointer-events-none"></div>
              
              <div className="relative z-10 flex flex-col h-full">
                <div className="w-12 h-12 md:w-14 md:h-14 bg-slate-900 rounded-xl flex items-center justify-center text-flolim mb-5 border border-slate-700 group-hover:bg-flolim group-hover:text-white transition-colors">
                   <svg className="w-6 h-6 md:w-7 md:h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path></svg>
                </div>
                <h4 className="text-lg font-bold text-white mb-2 group-hover:text-flolim transition-colors break-keep">LoRa-Mesh 솔루션</h4>
                <p className="text-xs md:text-sm text-slate-400 font-light leading-relaxed flex-grow break-keep">
                  매월 통신비 부담 없이, 수만 개의 조명을 촘촘하게 잇는 고신뢰성 무선 그물망 자가망 시스템
                </p>
                <div className="mt-6 text-flolim text-xs md:text-sm font-bold flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity translate-y-2 group-hover:translate-y-0 duration-300">
            ...
            <Link to="/smart-city/nb-iot" className="bg-[#050b14] p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim hover:bg-slate-800/80 active:scale-[0.98] active:border-flolim transition-all duration-300 group hover:-translate-y-2 flex flex-col h-full cursor-pointer relative overflow-hidden">
              <div className="absolute -right-6 -top-6 w-24 h-24 bg-flolim/5 rounded-full z-0 group-hover:scale-150 transition-transform duration-700 pointer-events-none"></div>

              <div className="relative z-10 flex flex-col h-full">
                <div className="w-12 h-12 md:w-14 md:h-14 bg-slate-900 rounded-xl flex items-center justify-center text-flolim mb-5 border border-slate-700 group-hover:bg-flolim group-hover:text-white transition-colors">
                   <svg className="w-6 h-6 md:w-7 md:h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z"></path></svg>
                </div>
                <h4 className="text-lg font-bold text-white mb-2 group-hover:text-flolim transition-colors break-keep">NB-IoT 솔루션</h4>
                <p className="text-xs md:text-sm text-slate-400 font-light leading-relaxed flex-grow break-keep">
            ...
            <Link to="/smart-city/dmx" className="bg-[#050b14] p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim hover:bg-slate-800/80 active:scale-[0.98] active:border-flolim transition-all duration-300 group hover:-translate-y-2 flex flex-col h-full cursor-pointer relative overflow-hidden">
              <div className="absolute -right-6 -top-6 w-24 h-24 bg-flolim/5 rounded-full z-0 group-hover:scale-150 transition-transform duration-700 pointer-events-none"></div>
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <h4 className="text-lg font-bold text-white mb-2 group-hover:text-flolim transition-colors break-keep">DMX512 경관 솔루션</h4>
                <p className="text-xs md:text-sm text-slate-400 font-light leading-relaxed flex-grow break-keep">
