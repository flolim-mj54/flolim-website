  ...
  const hardwares = [
    {
      ...
      features: [
        { title: '안전한 데이터 보관', text: '외부로 데이터를 보내지 않고 스케줄과 전력을 완벽히 보호합니다.' },
        { title: '강력한 폐쇄망 보안', text: '외부망과 단절된 폐쇄망으로 운영되어 해킹을 원천 차단합니다.' }
      ]
    },
    {
      id: '02',
      ...
      features: [
        { title: '기기 확장성 향상', text: '국제 표준 무선 모듈을 탑재하여 호환성이 뛰어납니다.' },
        { title: '정밀 밝기 제어', text: '환경에 맞춰 세밀한 디밍을 제공하여 에너지를 절약합니다.' }
      ]
    }
  ];
      ...
      <div className="container mx-auto px-4 max-w-6xl mt-10 md:mt-16">
        ...
        <section className="mb-20 md:mb-24 animate-fade-in">
          <div className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-6 md:p-10 lg:p-16 shadow-2xl border border-slate-800 relative overflow-hidden">
            ...
            <div className="text-center mb-8 md:mb-12 relative z-10">
              <h2 className="text-xl md:text-3xl font-bold text-white mb-2 md:mb-3 break-keep">센서 기반 도면 정밀 제어망</h2>
            ...
            <div className="flex flex-col gap-6 relative z-10">
              ...
              <div className="w-full h-48 md:h-56 bg-[#050b14] rounded-2xl md:rounded-3xl border border-slate-700 relative overflow-hidden shadow-inner flex flex-col justify-center">
                ...
                <div className="w-full h-20 md:h-24 border-y-2 border-dashed border-slate-600/50 relative flex items-center mt-4">
                  <div className="absolute w-10 md:w-12 h-5 md:h-6 bg-cyan-400 rounded-md shadow-[0_0_20px_#22d3ee] z-20 flex items-center justify-center" style={{ left: `${carPos}%`, transform: 'translateX(-50%)', transition: carPos === -20 ? 'none' : 'left 50ms linear' }}>
              ...
              <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="w-full lg:w-2/3 h-56 bg-[#050b14] rounded-2xl md:rounded-3xl border border-slate-700 relative overflow-hidden shadow-inner flex flex-col justify-center">
                  ...
                  <div className="absolute inset-0 z-0 pointer-events-none mix-blend-screen transition-opacity duration-1000 ease-out" style={{ background: 'linear-gradient(to left, rgba(251,191,36,0.25) 0%, rgba(251,191,36,0.05) 70%, transparent 100%)', opacity: sunlight / 100 }}></div>
                  ...
                  <div className="flex-1 flex justify-center items-center px-2 md:px-8 z-10 pt-10 pb-2">
                    <div className="grid grid-cols-3 gap-2 md:gap-10 w-full">
                      <div className="flex flex-col items-center">
                        ...
                        <div className="w-10 md:w-20 h-2 md:h-3 bg-white rounded-md shadow-[0_0_15px_#fff] mb-3 md:mb-4"></div>
                        <span className="text-[9px] md:text-xs text-white font-bold bg-slate-900/90 backdrop-blur border border-slate-700 px-2 md:px-3 py-1 md:py-1.5 rounded-md shadow-sm mb-1 text-center whitespace-nowrap">내측 1열<br className="sm:hidden"/>(100%)</span>
                      ...
                      <div className="flex flex-col items-center pr-2 md:pr-4">
                        ...
                        <div className="w-10 md:w-20 h-2 md:h-3 bg-white rounded-md transition-all duration-500 mb-3 md:mb-4" style={{ opacity: Math.max(0.1, 1 - sunlight/100), boxShadow: `0 0 ${20 * Math.max(0.1, 1 - sunlight/100)}px #fff` }}></div>
                        <span className={`text-[9px] md:text-xs font-bold bg-slate-900/90 backdrop-blur border px-2 md:px-3 py-1 md:py-1.5 rounded-md shadow-sm transition-colors duration-500 mb-1 text-center whitespace-nowrap ${sunlight > 0 ? 'text-amber-400 border-amber-500/60 shadow-[0_0_15px_rgba(245,158,11,0.25)]' : 'text-slate-400 border-slate-700'}`}>창측 3열<br className="sm:hidden"/>({dimmingWindow}%)</span>
                        <span className={`hidden sm:block text-[9px] md:text-xs font-bold text-cyan-400 mt-1 transition-opacity duration-300 ${sunlight > 0 ? 'opacity-100' : 'opacity-0'}`}>-{sunlight}% 절감</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-full lg:w-1/3 h-48 md:h-56 bg-[#050b14] rounded-2xl md:rounded-3xl border border-slate-700 px-6 py-6 md:py-8 flex flex-col justify-center items-center shadow-inner relative overflow-hidden">
                  <div className="relative z-10 w-full flex flex-col items-center justify-center h-full">
                    ...
                    <div className="text-2xl md:text-3xl font-black text-amber-400 mb-3 drop-shadow-[0_0_10px_rgba(251,191,36,0.3)]">{sunlight}%</div>
                    
                    <div className="w-full max-w-[200px] md:max-w-full relative px-2">
                      <input type="range" min="0" max="100" value={sunlight} onChange={(e) => setSunlight(Number(e.target.value))} className="w-full accent-amber-400 h-2 bg-slate-800 rounded-lg appearance-none cursor-pointer outline-none focus:ring-2 focus:ring-amber-400/50 transition-all border border-slate-600 shadow-inner" />
        ...
        <section className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-6 md:p-10 lg:p-16 shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
          <div className="flex flex-col lg:flex-row gap-10 md:gap-12 items-center relative z-10">
            ...
            <div className="lg:w-1/2 w-full flex flex-col items-center bg-[#050b14] p-6 md:p-8 rounded-2xl md:rounded-3xl border border-slate-700 relative overflow-hidden shadow-inner">
               ...
               <div className="flex justify-between w-full mb-8 relative z-10">
                  <div className={`flex flex-col items-center transition-opacity duration-500 ${isInternetConnected ? 'opacity-100' : 'opacity-30'}`}>
                    <div className={`w-10 h-10 md:w-14 md:h-14 rounded-xl md:rounded-2xl flex items-center justify-center mb-3 transition-colors ${isInternetConnected ? 'bg-slate-800 text-flolim border border-flolim/50 shadow-[0_0_15px_rgba(24,169,198,0.3)]' : 'bg-slate-800 text-slate-600 border border-slate-700'}`}>
                    ...
                    <span className="text-[9px] md:text-xs font-bold text-slate-400 tracking-wider whitespace-nowrap">외부 클라우드</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center">
                    <div className="w-10 h-10 md:w-14 md:h-14 bg-slate-800 rounded-xl md:rounded-2xl flex items-center justify-center text-flolim mb-3 border border-flolim/50 shadow-[0_0_15px_rgba(24,169,198,0.3)] relative">
                    ...
                    <span className="text-[9px] md:text-xs font-bold text-flolim tracking-wider whitespace-nowrap">현장 로컬서버</span>
                  </div>
               </div>

               <div className="w-full flex justify-end pr-5 md:pr-7 pb-4 relative z-10">
               ...
               <div className="w-full flex justify-around bg-slate-900/80 backdrop-blur-sm p-4 md:p-6 rounded-2xl border border-slate-700 relative z-10 shadow-lg">
                 <div className="flex flex-col items-center">
                   <svg className="w-4 h-4 md:w-6 md:h-6 text-flolim mb-2 shadow-[0_0_15px_rgba(24,169,198,0.2)] rounded-full" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 16a5 5 0 116 0 3 3 0 00-6 0zM10 20h4M12 22v-2"></path></svg>
                   <span className="text-[8px] md:text-[10px] text-slate-400 font-bold bg-slate-800 px-2 md:px-3 py-1 rounded-lg border border-slate-700 whitespace-nowrap">A구역</span>
                 </div>
                 <div className="flex flex-col items-center">
                   <svg className="w-4 h-4 md:w-6 md:h-6 text-flolim mb-2 shadow-[0_0_15px_rgba(24,169,198,0.2)] rounded-full" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 16a5 5 0 116 0 3 3 0 00-6 0zM10 20h4M12 22v-2"></path></svg>
                   <span className="text-[8px] md:text-[10px] text-slate-400 font-bold bg-slate-800 px-2 md:px-3 py-1 rounded-lg border border-slate-700 whitespace-nowrap">주차장</span>
                 </div>
                 <div className="flex flex-col items-center">
                   <svg className="w-4 h-4 md:w-6 md:h-6 text-flolim mb-2 shadow-[0_0_15px_rgba(24,169,198,0.2)] rounded-full" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 16a5 5 0 116 0 3 3 0 00-6 0zM10 20h4M12 22v-2"></path></svg>
                   <span className="text-[8px] md:text-[10px] text-slate-400 font-bold bg-slate-800 px-2 md:px-3 py-1 rounded-lg border border-slate-700 whitespace-nowrap">복도</span>
                 </div>
               </div>
        ...
        <section className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-6 md:p-10 lg:p-16 shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
          <div className="text-center mb-10 md:mb-12 relative z-10">
            <h2 className="text-xl md:text-3xl font-bold text-white break-keep">스마트 실내 조명 핵심 하드웨어</h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 relative z-10">
            {/* 💡 [Map 렌더링] 하드웨어 카드 반복 축소 */}
            {hardwares.map((hw) => (
              <div key={hw.id} className="bg-[#050b14] p-6 md:p-8 lg:p-10 rounded-2xl md:rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/50 active:scale-[0.98] active:border-flolim transition-all relative overflow-hidden group cursor-default">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-slate-800 text-flolim rounded-xl flex items-center justify-center text-lg md:text-xl font-black border border-slate-600 shrink-0">{hw.id}</div>
                    <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-white break-keep">{hw.title}</h3>
                  </div>
                  ...
                  <ul className="space-y-3 text-xs md:text-sm text-slate-300">
                    {hw.features.map((f, i) => (
                      <li key={i} className="flex items-start bg-slate-900/80 p-3 md:p-4 rounded-xl border border-slate-700 break-keep">
                        <svg className="w-4 h-4 text-flolim mr-2 md:mr-3 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg>
                        <div><strong className="block text-white mb-0.5">{f.title}</strong>{f.text}</div>
                      </li>
                    ))}
                  </ul>
                </div>
          ...
          <div className="relative z-10 pt-10 md:pt-16 mt-8 border-t border-slate-800 text-center">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 font-bold text-xs md:text-base">
               <div className="bg-[#050b14] w-full md:w-auto py-3 md:py-5 px-6 rounded-xl md:rounded-2xl border border-slate-700 shadow-inner flex flex-col items-center">
                 <svg className="w-5 h-5 md:w-6 md:h-6 text-slate-500 mb-1 md:mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01"></path></svg>
                 <span className="text-white whitespace-nowrap">현장 로컬 서버</span>
               </div>
               ...
               <div className="bg-[#050b14] w-full md:w-auto py-3 md:py-5 px-6 rounded-xl md:rounded-2xl border border-slate-700 shadow-inner flex flex-col items-center">
                 ...
                 <span className="text-white whitespace-nowrap">내부 무선망</span>
               </div>
               <div className="text-flolim rotate-90 md:rotate-0 text-xl md:text-2xl animate-pulse">⇌</div>
               <div className="bg-[#050b14] w-full md:w-auto py-3 md:py-5 px-6 rounded-xl md:rounded-2xl border border-flolim/50 shadow-[0_0_15px_rgba(24,169,198,0.15)] flex flex-col items-center text-flolim">
                 <svg className="w-5 h-5 md:w-6 md:h-6 mb-1 md:mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 16a5 5 0 116 0 3 3 0 00-6 0zM10 20h4M12 22v-2"></path></svg>
