  ...
  const cases = [
    {
      ...
      percent: "74.1",
      label: "절감",
      desc: "스마트조명 플랫폼 개별/그룹 제어 적용으로 전통 조명 대비 최대 74.1%의 압도적인 에너지를 절감했습니다.",
    },
    {
      id: 2,
      region: "대한민국 LH공사 실증",
    ...
    },
    {
      ...
      percent: "43",
      label: "추가 절감",
      desc: "자연광 연동 자동 제어 시스템을 통해, 고효율 일반 LED 조명에서 약 43%의 에너지를 추가로 절약했습니다.",
    },
  ];
  ...
  return (
    <div className="pb-10 bg-[#020617] min-h-screen font-sans overflow-hidden">
      <PageHeader
        ...
        subtitle={
          <>
            빌딩 내 모든 조명과 센서를 하나로 연결하여, 에너지를 낭비 없이
            완벽하게 통제하는{" "}
            ...
            <div className="lg:w-1/2 flex flex-col justify-center">
              ...
              <div className="space-y-4 mb-6 md:mb-8">
                <p className="text-slate-400 leading-relaxed font-light text-xs md:text-sm lg:text-base break-keep">
                  플로림의 스마트 빌딩 제어 시스템은 빌딩, 지하주차장, 사무실 등
                  실내 환경에 최적화된 스마트 조명 제어망입니다. 단순한 점소등을
                  넘어,{" "}
                  <strong className="text-white font-medium">
                    공간의 활용도와 주변 환경 데이터를 실시간으로 수집
                  </strong>
                  하여 능동적으로 반응합니다.
                </p>
              </div>
                ...
                <ul className="space-y-3 md:space-y-4 text-slate-300 text-xs md:text-sm font-light bg-[#050b14] p-5 md:p-7 rounded-2xl md:rounded-3xl border border-slate-700 shadow-inner">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="flex-1 leading-relaxed break-keep">
                      관리자 대시보드를 통해 구역별 정밀한 스케줄링 및 원격 그룹
                      제어 지원
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span className="flex-1 leading-relaxed break-keep">
                      매월 ESG 리포트를 발행하여 탄소 배출 저감 성과 증빙 및
                      기업 가치 제고
                    </span>
                  </li>
                </ul>
        ...
        <section className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-8 md:p-16 shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
          ...
          <div className="text-center mb-10 md:mb-12 relative z-10 px-2">
            ...
            <p className="text-slate-400 font-light text-xs md:text-base break-keep">
              단순한 LED 교체를 넘어, IoT 센서 연동 제어로{" "}
              <strong className="text-flolim font-bold">
                최대 70% 이상의 압도적인 에너지 절감률
              </strong>
              을 실현합니다.
            </p>
          </div>
            ...
            {cases.map((c) => (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <p className="text-[11px] md:text-xs text-slate-500 font-medium mb-6 break-keep flex-grow">
                    {c.location}
                  </p>
                  ...
                  <div className="flex flex-wrap items-end gap-x-2 gap-y-1 mt-auto mb-4">
                    ...
                    <span className="text-3xl md:text-4xl font-black text-flolim tracking-tight drop-shadow-[0_0_15px_rgba(24,169,198,0.3)] whitespace-nowrap">
                      {c.percent}
                      <span className="text-lg md:text-2xl font-medium ml-0.5">
                        %
                      </span>
                    </span>
          ...
          <div className="flex justify-center relative z-10">
            ...
            >
              ...
              <div className="flex-grow text-center md:text-left relative z-10">
                <h4 className="text-lg md:text-xl font-bold text-white mb-2 group-hover:text-flolim transition-colors break-keep">
                  IoT 센서 자동 제어
                </h4>
