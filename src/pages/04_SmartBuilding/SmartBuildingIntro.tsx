      ...
      <div className="container mx-auto px-4 max-w-6xl mt-10">
            ...
            <div className="lg:w-1/2 w-full flex flex-col items-center justify-center">
              <div className="relative w-full aspect-square md:aspect-[4/3] bg-[#050b14] rounded-3xl border border-slate-700 overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] group">
                <img 
                  ...
                  onError={(e) => {
                    e.currentTarget.src = "https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=1000&auto=format&fit=crop";
                  }}
                />
                ...
                <div className="absolute top-6 right-6 z-10 flex items-center gap-2 bg-slate-900/80 backdrop-blur-md px-4 py-2 rounded-xl border border-slate-700 shadow-lg">
                  ...
                  <span className="text-[11px] font-bold text-white tracking-widest">스마트 빌딩 인프라</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-10 md:p-16 shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
          ...
          <div className="text-center mb-12 relative z-10">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">단순한 교체를 넘은 획기적 절감</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 relative z-10">
            ...
            <div className="bg-[#050b14] p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-all duration-300 group relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-lg font-bold text-white mb-2 group-hover:text-flolim transition-colors">대한민국 ETRI 실증</h3>
                <p className="text-xs text-slate-500 font-medium mb-6">공장 및 상업시설</p>
                ...
                <p className="text-xs text-slate-400 leading-relaxed font-light break-keep">
            ...
            <div className="bg-[#050b14] p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-all duration-300 group relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-lg font-bold text-white mb-2 group-hover:text-flolim transition-colors">대한민국 LH공사 실증</h3>
                <p className="text-xs text-slate-500 font-medium mb-6">공동주택 및 건물</p>
                <div className="flex items-end gap-2 mb-4">
            ...
            <div className="bg-[#050b14] p-8 rounded-3xl border border-slate-700 shadow-inner hover:border-flolim/50 transition-all duration-300 group relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-lg font-bold text-white mb-2 group-hover:text-flolim transition-colors">한국광기술원 실증</h3>
                <p className="text-xs text-slate-500 font-medium mb-6">학교 및 사무실</p>
                <div className="flex items-end gap-2 mb-4">
        ...
        <section className="bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-10 md:p-16 shadow-2xl border border-slate-800 mb-16 relative overflow-hidden">
          <div className="text-center mb-10 relative z-10">
            <h2 className="text-2xl font-bold text-white mb-4">빌딩 에너지를 지휘하는 스마트 두뇌</h2>
          ...
          <div className="flex justify-center relative z-10">
            <Link to="/smart-building/sensor" className="bg-[#050b14] border border-slate-700 shadow-inner rounded-3xl p-8 hover:border-flolim hover:bg-slate-800/80 transition-all duration-300 group flex flex-col md:flex-row items-center gap-8 w-full max-w-4xl cursor-pointer relative overflow-hidden">
              ...
              <div className="w-20 h-20 bg-slate-900 rounded-2xl flex items-center justify-center text-flolim border border-slate-700 group-hover:bg-flolim group-hover:text-white transition-colors shrink-0 shadow-sm relative z-10">
              ...
              <div className="flex-grow text-center md:text-left relative z-10">
                <h4 className="text-xl font-bold text-white mb-2 group-hover:text-flolim transition-colors">IoT 센서 자동 제어</h4>
                <p className="text-sm text-slate-400 font-light leading-relaxed break-keep">
