    ...
    script.onload = () => {
      ...
      window.kakao.maps.load(() => {
        ...
        const infowindow = new window.kakao.maps.InfoWindow({
          content:
            '<div style="padding:5px 10px; font-size:14px; font-weight:bold; color:#1eb4c8; text-align:center; border:none;">주식회사 플로림</div>',
        });
      ...
      <div className="w-full bg-slate-50 py-12 border-b border-slate-200 border-t-4 border-t-[#1eb4c8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-sm text-slate-500 mb-2 font-medium">
            홈 〉 회사소개 〉{" "}
            <span className="text-[#1eb4c8] font-bold">오시는 길</span>
          </div>
        ...
        <section className="flex-1 min-w-0">
          ...
          <div className="bg-slate-50 border border-slate-200 p-8 mb-10">
            ...
            <ul className="space-y-4 text-[15px] text-slate-700">
              <li className="flex items-start">
                ...
                <div>
                  <span className="text-slate-500 mr-2">[도로명]</span>충남
                  천안시 서북구 2공단4로 40-11 천안G1비즈캠퍼스 1223호 주식회사
                  플로림 <br />
                  <span className="text-slate-500 mr-2">
                    [지&nbsp;&nbsp;&nbsp;번]
                  </span>
                  충남 천안시 서북구 성성동 1001 천안G1비즈캠퍼스 1223호
                  주식회사 플로림
                </div>
              </li>
              <li className="flex items-start">
                <span className="w-24 font-bold text-slate-800 shrink-0 mt-1">
                  대표 전화
                </span>
                <span className="mt-1 text-lg font-bold text-[#1eb4c8]">
                  1660-0687
                </span>
              </li>
              <li className="flex items-start">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-slate-200 p-6">
              <h4 className="text-[#1eb4c8] font-black text-lg mb-3 flex items-center">
                <span className="text-2xl mr-2">🚆</span> 대중교통 이용 시
              </h4>
              <p className="text-sm text-slate-600 leading-relaxed break-keep">
                수도권 전철 1호선 <b>두정역</b> 하차 후, 택시 또는 버스를
                이용하여 천안제2일반산업단지 방면으로 이동
              </p>
            </div>
            <div className="border border-slate-200 p-6">
              <h4 className="text-[#1eb4c8] font-black text-lg mb-3 flex items-center">
                <span className="text-2xl mr-2">🚘</span> 자가용 이용 시
              </h4>
              <p className="text-sm text-slate-600 leading-relaxed break-keep">
                경부고속도로 <b>천안IC</b> 진출 후 천안제2일반산업단지 교차로
                방면. 내비게이션에 주소 검색 후 방문해 주세요.
              </p>
            </div>
          </div>
        </section>
