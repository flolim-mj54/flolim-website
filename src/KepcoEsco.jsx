        ...
        <section className="flex-1 min-w-0">
          ...
          <div className="mb-14">
            ...
            <p className="text-slate-700 leading-relaxed break-keep text-[15px]">
              플로림(FLOLIM)은 한국전력공사의 자회사인{" "}
              <b>켑코이에스(KEPCO ESCO)</b>와 연계하여, 고객의 초기 투자 비용
              부담을 완전히 없앤 스마트 조명 교체 사업을 진행합니다. 노후된
              조명을 고효율 스마트 LED 시스템으로 교체하고, 여기서 발생하는{" "}
              <b>'전기요금 절감액'으로 투자비를 분할 상환</b>하는 획기적인
              비즈니스 모델입니다.
            </p>
          </div>
          ...
          <div className="mb-14">
            ...
            <ul className="space-y-3 text-[15px] text-slate-700">
              <li className="flex items-start">
                ...
                <b>초기 투자비 0원 :</b> 장비, 시스템 구축, 시공비 전액을
                켑코이에스에서 선투자
              </li>
              <li className="flex items-start">
                <span className="text-[#1eb4c8] mr-2 font-bold">■</span>
                <b>비용 회수 보장 :</b> 교체 전/후 전기요금 차액(절감액)만으로
                상환하여 예산 부담 제로
              </li>
              <li className="flex items-start">
                <span className="text-[#1eb4c8] mr-2 font-bold">■</span>
                <b>유지보수 보장 :</b> 상환 기간 동안 플로림의 완벽한 시스템
                사후 관리(A/S) 지원
              </li>
            </ul>
          </div>
            ...
            <div className="w-full bg-slate-50 border border-slate-200 p-8 flex flex-col items-center justify-center min-h-[300px]">
              <div className="text-center">
                <span className="text-slate-400 font-bold tracking-widest block mb-2">
                  [ ESCO 사업 프로세스 다이어그램 삽입 영역 ]
                </span>
                <span className="text-sm text-slate-400">
                  에너지 진단 ➡️ 사업 계약 ➡️ 스마트 LED 시공 ➡️ 절감액 상환
                </span>
              </div>
            </div>
            {/* ESCO Diagram Placeholder  */}
          </div>
        </section>
      </div>
    </div>
