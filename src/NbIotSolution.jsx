        ...
        <aside className="w-full md:w-64 flex-shrink-0">
          <div className="border border-slate-300">
            ...
            <ul className="flex flex-col">
              ...
              <li className="border-b border-slate-200 last:border-0"><Link to="/nbiot" className="flex items-center justify-between px-5 py-4 bg-cyan-50 text-[#1eb4c8] font-bold">NB-IoT 솔루션 <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="square" strokeLinejoin="miter" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg></Link></li>
            </ul>
          </div>
        </aside>
        <section className="flex-1 min-w-0">
          <h2 className="text-3xl font-black text-slate-800 tracking-tight mb-8 pb-4 border-b-2 border-slate-200">
            NB-IoT 솔루션 <span className="text-lg text-slate-400 font-normal tracking-widest uppercase ml-2">Specification</span>
          </h2>
          <div className="mb-14">
            ...
            <p className="text-slate-700 leading-relaxed break-keep text-[15px]">
              NB-IoT(협대역 사물인터넷) 솔루션은 기존 이동통신사의 전국망 기지국을 그대로 활용하여 통신하는 방식입니다. <b>초기 중계기(게이트웨이) 구축 비용이 발생하지 않으며</b>, 단말기 하나만 설치하면 스마트폰이 터지는 전국 어디서나 즉시 서버와 연결됩니다.
            </p>
          </div>
          <div className="mb-14">
            ...
            <ul className="space-y-3 text-[15px] text-slate-700">
              <li className="flex items-start"><span className="text-[#1eb4c8] mr-2 font-bold">■</span>게이트웨이/중계기 설치 불필요 (초기 인프라 비용 절감)</li>
              <li className="flex items-start"><span className="text-[#1eb4c8] mr-2 font-bold">■</span>통신사 상용망 활용으로 산간/오지 등 음영 지역 최소화</li>
              <li className="flex items-start"><span className="text-[#1eb4c8] mr-2 font-bold">■</span>가로등 1:1 개별 직접 통신으로 장애 발생 시 독립적 대응 가능</li>
            </ul>
          </div>
          <div className="mb-14">
            ...
            <div className="w-full bg-slate-50 border border-slate-200 p-8 flex flex-col items-center justify-center min-h-[400px]">
              <div className="text-center">
                ...
                <span className="text-slate-400 font-bold tracking-widest block mb-2">[ NB-IoT 통신 구조도 이미지 삽입 영역 ]</span>
                <span className="text-sm text-slate-400">관제 서버 ↔ 통신사 기지국(LTE) ↔ NB-IoT 개별 단말기</span>
              </div>
            </div>
          </div>
          <div className="mb-14">
            ...
            <table className="w-full border-t-2 border-slate-800 text-[14px]">
              <tbody>
                <tr className="border-b border-slate-200"><th className="bg-slate-50 py-3 px-4 text-left font-bold text-slate-700 w-1/4">통신 방식</th><td className="py-3 px-4 text-slate-600">NB-IoT (이동통신사 상용망)</td></tr>
                <tr className="border-b border-slate-200"><th className="bg-slate-50 py-3 px-4 text-left font-bold text-slate-700">USIM 형태</th><td className="py-3 px-4 text-slate-600">내장형 / 외장형 USIM 지원</td></tr>
                <tr className="border-b border-slate-200"><th className="bg-slate-50 py-3 px-4 text-left font-bold text-slate-700">입력 전압 / 디밍</th><td className="py-3 px-4 text-slate-600">AC 100~240V / 0-10V DC Dimming</td></tr>
              </tbody>
            </table>
          </div>
        </section>
