        ...
        <aside className="w-full md:w-64 flex-shrink-0">
          <div className="border border-slate-300">
            ...
            <ul className="flex flex-col">
              ...
              <li className="border-b border-slate-200"><Link to="/history" className="flex items-center justify-between px-5 py-4 bg-cyan-50 text-[#1eb4c8] font-bold">연혁 <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="square" strokeLinejoin="miter" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg></Link></li>
        ...
        <section className="flex-1 min-w-0">
          ...
          <div className="relative border-l-2 border-[#1eb4c8] ml-4 md:ml-6 mt-10">
            <div className="mb-10 ml-8">
              <span className="absolute flex items-center justify-center w-8 h-8 bg-[#1eb4c8] rounded-full -left-[17px] ring-4 ring-white text-white font-bold text-sm">'25</span>
