        ...
        <section className="flex-1 min-w-0">
          ...
          <div className="mb-14">
            ...
            <p className="text-slate-700 leading-relaxed break-keep text-[15px]">
              플로림(FLOLIM)의 스마트 LED 전등 제어 시스템은 차세대 스마트홈 및
              빌딩 자동화의 국제 표준인 <b>Matter(매터) 프로토콜</b>을 기반으로
              구축됩니다. 기존의 폐쇄적인 조명 제어 방식에서 벗어나, 뛰어난
              호환성과 확장성을 바탕으로 실내외 모든 조명을 하나의 플랫폼에서
              통합 관리하여 혁신적인 에너지 절감과 사용자 편의성을 제공합니다.
            </p>
          </div>
          <div className="mb-14">
            <h3 className="text-2xl font-bold text-[#1eb4c8] border-b border-slate-300 pb-2 mb-6 inline-block pr-8">
            ...
            <ul className="space-y-3 text-[15px] text-slate-700">
              <li className="flex items-start">
                <span className="text-[#1eb4c8] mr-2 font-bold">■</span>국제
                표준 Matter 프로토콜 적용으로 완벽한 이기종 기기 호환성 보장
              </li>
              <li className="flex items-start">
                <span className="text-[#1eb4c8] mr-2 font-bold">■</span>사용자
                재실 유무 및 자연 채광량을 감지하는 복합 센서 연동 디밍 제어
              </li>
              <li className="flex items-start">
                <span className="text-[#1eb4c8] mr-2 font-bold">■</span>무선
                통신 기반 시스템으로 별도의 복잡한 배선 공사 없이 간편한 설치
              </li>
            </ul>
          </div>
          <div className="mb-14">
            ...
            <div className="w-full bg-slate-50 border border-slate-200 h-[300px] flex flex-col items-center justify-center">
              <span className="text-slate-400 font-bold tracking-widest mb-4">
                [ 스마트 LED 시스템 구성도 이미지 삽입 ]
              </span>
              <span className="text-sm text-slate-400">
                통합 관제 서버 ↔ Matter 게이트웨이 ↔ 스마트 LED 조명 & 센서
              </span>
            </div>
          </div>
          <div className="mb-14">
              ...
              <tbody>
                <tr className="border-b border-slate-200">
                  ...
                  <td className="py-3 px-4 text-slate-600">
                    회의실, 업무 공간의 스케줄링 및 재실 센서 연동 에너지 절감
                  </td>
                </tr>
                <tr className="border-b border-slate-200">
                  ...
                  <td className="py-3 px-4 text-slate-600">
                    차량 및 보행자 동선에 맞춘 구역별 자동 디밍(Dimming) 제어
                  </td>
                </tr>
                <tr className="border-b border-slate-200">
                  <th className="bg-slate-50 py-3 px-4 text-left font-bold text-slate-700">
                  ...
                  <td className="py-3 px-4 text-slate-600">
                    넓은 실내 공간의 구역별 통합 그룹 제어 및 조도 유지 관리
                  </td>
                </tr>
              </tbody>
            </table>
